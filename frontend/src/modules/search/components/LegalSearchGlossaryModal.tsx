      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[85vh] flex flex-col">
        <div className="flex items-center justify-between p-5 border-b border-slate-200/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-bold text-slate-900 text-[15px]">Glosario jurídico</h2>
        ...
        <div className="p-4 border-b border-slate-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-50/70 border border-slate-200/80 rounded-xl pl-10 pr-4 py-2.5 text-slate-800 text-[13px] focus:outline-none focus:ring-1 focus:ring-blue-900/20 focus:border-blue-900/40"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          ...
          {!isLoading && items.length === 0 && (
            <div className="bg-amber-50/60 border border-amber-200/70 rounded-xl p-5 flex items-start gap-3">
          ...
          {!isLoading &&
            items.map((item) => (
              <div key={item.id} className="bg-white border border-slate-200/80 rounded-xl p-4 space-y-2">
                <div className="flex items-start justify-between gap-3">
                  <h3 className="font-bold text-slate-900 text-[13.5px] leading-tight">{item.term}</h3>
                ...
                <div className="flex items-center justify-between pt-1.5 border-t border-slate-100">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200/80 text-slate-700 rounded-lg text-[11px] font-semibold flex items-center gap-1.5 transition-colors"
                    >
