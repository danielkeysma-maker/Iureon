...
1. **🏢 Aprovisionamiento Estricto & Flexibilidad para Particulares**:
...
2. **✏️🗑️ Edición y Eliminación Completa de Firmas y Usuarios**:
...
3. **⚠️ Modales de Advertencia y Confirmación Previa (`ActionConfirmationModal.tsx`)**:
...
4. **👤👑 Contextos de Usuario Desvinculados de Firma**:
...
5. **💳 Modelo Económico de Recargas de Créditos Procesales (Pay-As-You-Go)**:
...
6. **🔑 Portal de Inicio de Sesión Multi-Tenant (`LoginPortalView.tsx`)**:
   - Autenticación limpia con resolución automática del rol y la firma según las credenciales del usuario.

7. **🤖 Pipeline de Inteligencia Artificial de 3 Motores**:
