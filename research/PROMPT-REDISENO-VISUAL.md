...
**Después, las pantallas, en 1440px:**
...
11. **Login** (`LoginPortalView.tsx`) — es la primera impresión del producto.
12. **Saldo y recarga**: saldo en pesos, historial y recarga mínima de $100.000 COP.
