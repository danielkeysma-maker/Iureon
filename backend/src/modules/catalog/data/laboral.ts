...
export const LABORAL_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 2452 de 2025, arts. 69 y 255 — FUNDAMENTO SUSTANCIAL (las excepciones de fondo, no el trámite): Código Sustantivo del Trabajo, art. 62 (modificado por el art. 7 del Decreto 2351 de 1965), que enumera las justas causas para dar por terminado unilateralmente el contrato de trabajo, por parte del empleador y por parte del trabajador; y arts. 488 (modificado por el art. 62 de la Ley 2466 de 2025) y 489: las acciones correspondientes a los derechos regulados en el Código prescriben en tres (3) años contados, cuando se reclamen derechos emanados de una relación de trabajo, desde que la respectiva obligación se hace exigible, salvo las prescripciones especiales del CPTSS o del propio estatuto; el simple reclamo escrito del trabajador recibido por el empleador, sobre un derecho debidamente determinado, interrumpe la prescripción por una sola vez y por un lapso igual.',
  ...
  },
  {
    ...
    term: { status: 'VERIFICADO', description: 'ORALMENTE EN LA AUDIENCIA en que se profiera la providencia, o POR ESCRITO DENTRO DE LOS TRES (3) DÍAS siguientes cuando se notifique fuera de audiencia. Tratándose de SENTENCIA, la sustentación se presenta por escrito dentro de los CINCO (5) DÍAS siguientes (art. 230). Todos son relojes del recurrente. NO BASTA CON INTERPONERLO EN TIEMPO: la sustentación debe EXPRESAR LAS RAZONES JURÍDICAS Y FÁCTICAS de la inconformidad, y si no se sustenta, o se sustenta fuera de término, el juez de primera instancia DECLARA DESIERTO el recurso (art. 230 par. 2). ADHESIÓN, QUE ES LA SEGUNDA OPORTUNIDAD DE QUIEN NO APELÓ: puede adherir a la apelación del contrario en lo que la providencia le sea desfavorable, presentándola y sustentándola ante el juez que profirió la providencia DENTRO DEL TÉRMINO QUE ESTE TIENE PARA RESOLVER SOBRE LA CONCESIÓN — los tres (3) días siguientes al vencimiento del traslado a los no recurrentes (art. 230 par. 1 e inc. final). La adhesión QUEDA SIN EFECTO SI EL APELANTE PRINCIPAL DESISTE, de modo que no sustituye a la apelación propia cuando lo que se busca es asegurar la revisión. QUÉ SIGUE: sustentado el recurso, se corre traslado POR SECRETARÍA a las partes no recurrentes por el mismo término.' },
    requiredSections: [
  ...
  },
  {
    ...
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 2452 de 2025, arts. 293, 294 y 298 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Código Sustantivo del Trabajo, arts. 405 (modificado por el art. 1 del Decreto Legislativo 204 de 1957) y 406 (modificado por el art. 12 de la Ley 584 de 2000): el fuero sindical es la garantía de que gozan algunos trabajadores de no ser despedidos, ni desmejorados en sus condiciones de trabajo, ni trasladados a otros establecimientos de la misma empresa o a un municipio distinto, sin justa causa previamente calificada por el juez del trabajo; están amparados los fundadores del sindicato y quienes ingresen antes de la inscripción en el registro sindical —desde la constitución hasta dos (2) meses después de la inscripción, sin exceder de seis (6) meses— y los miembros de la junta directiva y subdirectivas, hasta cinco (5) principales y cinco (5) suplentes, y de los comités seccionales, un (1) principal y un (1) suplente, por el tiempo que dure el mandato y seis (6) meses más; art. 408 (modificado por el art. 7 del Decreto 204 de 1957): comprobado que el trabajador fue despedido sin sujeción a las normas que regulan el fuero sindical, se ordena su reintegro y se condena al empleador a pagarle, a título de indemnización, los salarios dejados de percibir por causa del despido; en los casos de traslado o desmejora se ordena la restitución al lugar donde antes prestaba sus servicios o a sus anteriores condiciones de trabajo, con las correspondientes indemnizaciones.',
  ...
  },
  {
    ...
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 2452 de 2025, arts. 292, 294 y 298 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Código Sustantivo del Trabajo, arts. 405 (modificado por el art. 1 del Decreto Legislativo 204 de 1957) y 406 (modificado por el art. 12 de la Ley 584 de 2000): el fuero sindical es la garantía de que gozan algunos trabajadores de no ser despedidos, ni desmejorados en sus condiciones de trabajo, ni trasladados a otros establecimientos de la misma empresa o a un municipio distinto, sin justa causa previamente calificada por el juez del trabajo; están amparados los fundadores del sindicato y quienes ingresen antes de la inscripción en el registro sindical —desde la constitución hasta dos (2) meses después de la inscripción, sin exceder de seis (6) meses— y los miembros de la junta directiva y subdirectivas, hasta cinco (5) principales y cinco (5) suplentes, y de los comités seccionales, un (1) principal y un (1) suplente, por el tiempo que dure el mandato y seis (6) meses más; arts. 410 (modificado por el art. 8 del Decreto Legislativo 204 de 1957) y 411 (modificado por el art. 9 del Decreto 204 de 1957): son justas causas para que el juez autorice el despido de un trabajador amparado por el fuero la liquidación o clausura definitiva de la empresa o establecimiento y la suspensión total o parcial de actividades por parte del empleador durante más de ciento veinte (120) días, y las causales enumeradas en los arts. 62 y 63 para dar por terminado el contrato; la terminación por la realización de la obra contratada, por trabajo accidental, ocasional o transitorio, por mutuo consentimiento o por sentencia de autoridad competente no requiere previa calificación judicial en ningún caso.',
    competentAuthority: 'Juez laboral del circuito',
  ...
  },
  {
    ...
    branch: 'LABORAL',
    role: 'DESPACHO',
    legalBasis: 'Ley 2452 de 2025, arts. 292 a 299 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Código Sustantivo del Trabajo, arts. 405 (modificado por el art. 1 del Decreto Legislativo 204 de 1957) y 406 (modificado por el art. 12 de la Ley 584 de 2000): el fuero sindical es la garantía de que gozan algunos trabajadores de no ser despedidos, ni desmejorados en sus condiciones de trabajo, ni trasladados a otros establecimientos de la misma empresa o a un municipio distinto, sin justa causa previamente calificada por el juez del trabajo; están amparados los fundadores del sindicato y quienes ingresen antes de la inscripción en el registro sindical —desde la constitución hasta dos (2) meses después de la inscripción, sin exceder de seis (6) meses— y los miembros de la junta directiva y subdirectivas, hasta cinco (5) principales y cinco (5) suplentes, y de los comités seccionales, un (1) principal y un (1) suplente, por el tiempo que dure el mandato y seis (6) meses más; art. 408 (modificado por el art. 7 del Decreto 204 de 1957): comprobado que el trabajador fue despedido sin sujeción a las normas que regulan el fuero sindical, se ordena su reintegro y se condena al empleador a pagarle, a título de indemnización, los salarios dejados de percibir por causa del despido; en los casos de traslado o desmejora se ordena la restitución al lugar donde antes prestaba sus servicios o a sus anteriores condiciones de trabajo, con las correspondientes indemnizaciones; arts. 410 (modificado por el art. 8 del Decreto Legislativo 204 de 1957) y 411 (modificado por el art. 9 del Decreto 204 de 1957): son justas causas para que el juez autorice el despido de un trabajador amparado por el fuero la liquidación o clausura definitiva de la empresa o establecimiento y la suspensión total o parcial de actividades por parte del empleador durante más de ciento veinte (120) días, y las causales enumeradas en los arts. 62 y 63 para dar por terminado el contrato; la terminación por la realización de la obra contratada, por trabajo accidental, ocasional o transitorio, por mutuo consentimiento o por sentencia de autoridad competente no requiere previa calificación judicial en ningún caso.',
    competentAuthority: 'Juez laboral del circuito',
    term: { status: 'VERIFICADO', description: 'DOS (2) DÍAS PARA LA NUEVA AUDIENCIA SI NO SE PUDO FALLAR DE INMEDIATO, Y ESE RELOJ ES DEL JUEZ (art. 294). EL PLAZO DEL CLIENTE FRENTE A LA SENTENCIA: la de fuero sindical es APELABLE EN EL EFECTO SUSPENSIVO (art. 297), y la oportunidad para recurrirla se rige por el art. 230 — oralmente en la audiencia en que se profiera, con sustentación por escrito dentro de los CINCO (5) DÍAS siguientes por tratarse de sentencia, o por escrito dentro de los TRES (3) DÍAS siguientes si se notifica fuera de audiencia—, so pena de que el juez de primera instancia la declare desierta. DOS RELOJES DEL DESPACHO QUE NO HAY QUE CONFUNDIR CON LOS ANTERIORES: los dos (2) días para la nueva audiencia son del juez que no pudo fallar de inmediato; los cinco (5) días del art. 297 son del tribunal, que decide DE PLANO dentro de los cinco días siguientes al recibo del expediente. CONTENIDO DEL FALLO (art. 296): en la acción del trabajador, comprobado el despido sin sujeción a las normas del fuero, se ordena el REINTEGRO y se condena al empleador a pagar, SIN SOLUCIÓN DE CONTINUIDAD, salarios, prestaciones y demás emolumentos dejados de percibir.' },
    requiredSections: [
  ...
  },
  {
    ...
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 2452 de 2025, art. 275 num. 1 y num. 2; art. 273 (orden de ejecución) — FUNDAMENTO SUSTANCIAL (la excepción de fondo, no el trámite): Código Sustantivo del Trabajo, arts. 488 (modificado por el art. 62 de la Ley 2466 de 2025) y 489: las acciones correspondientes a los derechos regulados en el Código prescriben en tres (3) años contados, cuando se reclamen derechos emanados de una relación de trabajo, desde que la respectiva obligación se hace exigible, salvo las prescripciones especiales del CPTSS o del propio estatuto; el simple reclamo escrito del trabajador recibido por el empleador, sobre un derecho debidamente determinado, interrumpe la prescripción por una sola vez y por un lapso igual.',
  ...
  {
    id: 'laboral/citacion-a-descargos-y-acta-de-la-diligencia',
    exactName: 'Citación a descargos y acta de la diligencia',
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Código Sustantivo del Trabajo, art. 115, modificado por el art. 7 de la Ley 2466 de 2025',
    competentAuthority: 'Ninguna: es un procedimiento interno del empleador. No interviene juez ni inspector, y por eso su validez depende enteramente de que el escrito cumpla el debido proceso',
    term: { status: 'VERIFICADO', description: 'CINCO (5) DÍAS COMO MÍNIMO PARA QUE EL TRABAJADOR SE DEFIENDA, Y ES UN PISO, NO UN TECHO: el empleador puede dar más, nunca menos. «La indicación de un término durante el cual el trabajador o trabajadora pueda manifestarse frente a los motivos del proceso, controvertir las pruebas y allegar las que considere necesarias para sustentar su defensa EL CUAL EN TODO CASO NO PODRÁ SER INFERIOR A 5 DÍAS» (num. 4). Citar a descargos «para mañana» invalida el procedimiento entero y con él la justa causa que se pretenda derivar. EL PROCEDIMIENTO ES DE SIETE PASOS Y TODOS SON MÍNIMOS: comunicación formal de la apertura; indicación POR ESCRITO de los hechos, conductas u omisiones; traslado al trabajador de TODAS Y CADA UNA de las pruebas que los fundamentan; el término de defensa de al menos cinco días; pronunciamiento definitivo motivado que identifique específicamente la causa; sanción proporcional; y «La posibilidad del trabajador de IMPUGNAR la decisión». SI LOS DESCARGOS SON VERBALES, hay que levantar acta «en la que se transcribirá la versión o descargos rendidos por el trabajador». RELOJ SIN NÚMERO PERO EXIGIBLE: el par. 1 ordena que todo se haga «en un término razonable atendiendo al PRINCIPIO DE INMEDIATEZ», salvo que la convención, el laudo o el reglamento fijen otro. Sancionar meses después del hecho es perder la causa por tardanza. TRES GARANTÍAS QUE SE OMITEN Y ANULAN LA SANCIÓN: el trabajador sindicalizado puede estar acompañado por uno o dos representantes del sindicato que sean trabajadores de la empresa; el trabajador con discapacidad debe contar con ajustes razonables que garanticen la comunicación recíproca; y el procedimiento puede hacerse por medios tecnológicos SOLO si el trabajador cuenta con esas herramientas. EXCEPCIÓN QUE HAY QUE VERIFICAR ANTES DE ARMAR EL EXPEDIENTE: el par. 6 exime de este procedimiento a los trabajadores del hogar y a «las micro y pequeñas empresas de menos de diez (10) trabajadores», que solo deben escuchar previamente al trabajador respetando el derecho de defensa.' },
    requiredSections: [
      { n: 1, name: 'Comunicación formal de la apertura del proceso disciplinario', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 1' },
      { n: 2, name: 'Indicación por escrito de los hechos, conductas u omisiones que lo motivan', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 2' },
      { n: 3, name: 'Traslado de todas y cada una de las pruebas que fundamentan los cargos', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 3' },
      { n: 4, name: 'Señalamiento del término de defensa, que no puede ser inferior a cinco (5) días', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 4' },
      { n: 5, name: 'Acta que transcriba la versión del trabajador, cuando los descargos sean verbales', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 4' },
      { n: 6, name: 'Advertencia del derecho a estar acompañado por representantes del sindicato y de los ajustes razonables si hay discapacidad', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 par. 2 y 3' },
      { n: 7, name: 'Pronunciamiento motivado que identifique la causa, con sanción proporcional y aviso de la posibilidad de impugnar', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115 num. 5, 6 y 7' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/codigo_sustantivo_trabajo_pr003.html'
  },
  {
    id: 'laboral/carta-de-terminacion-del-contrato-de-trabajo-con-justa-causa',
    exactName: 'Carta de terminación del contrato de trabajo con justa causa',
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Código Sustantivo del Trabajo, arts. 62 (subrogado por el art. 7 del Decreto 2351 de 1965) y 66; art. 115, modificado por el art. 7 de la Ley 2466 de 2025',
    competentAuthority: 'Ninguna: la terminación la comunica el empleador al trabajador. El control es judicial y posterior, ante el juez laboral',
    term: { status: 'VERIFICADO', description: 'NO HAY PLAZO PARA DESPEDIR, PERO SÍ UNA REGLA QUE CIERRA LA PUERTA EN EL INSTANTE Y NO SE PUEDE REABRIR DESPUÉS: «La parte que termina unilateralmente el contrato de trabajo DEBE MANIFESTAR A LA OTRA, EN EL MOMENTO DE LA EXTINCIÓN, la causal o motivo de esta determinación. POSTERIORMENTE NO PUEDEN ALEGARSE VÁLIDAMENTE CAUSALES O MOTIVOS DISTINTOS» (art. 66). Esa frase es la que decide el pleito dos años después: lo que no quedó escrito en la carta no existe en el juicio, por probado que esté. De ahí que la carta se redacte con los hechos completos y no con una remisión genérica al numeral. EL RELOJ QUE SÍ CORRE ES EL DE LA INMEDIATEZ, sin número: el par. 1 del art. 115 exige que el procedimiento disciplinario se surta «en un término razonable atendiendo al principio de inmediatez». Despedir por un hecho de hace seis meses convierte la justa causa en una decisión tardía. REQUISITO PREVIO QUE SE OMITE Y TUMBA EL DESPIDO: cuando la causal supone una falta del trabajador, hay que agotar antes el procedimiento del art. 115 —descargos con mínimo cinco días y traslado de pruebas—, salvo la excepción de su par. 6 para trabajadores del hogar y empresas de menos de diez trabajadores. VERIFICACIÓN QUE VA ANTES DE TODO: si la trabajadora está en embarazo o en las dieciocho semanas posteriores al parto, o si el trabajador tiene cónyuge o compañera embarazada sin empleo formal, NO SE PUEDE DESPEDIR sin autorización del Inspector del Trabajo (arts. 239 y 240).' },
    requiredSections: [
      { n: 1, name: 'Identificación de las partes, del contrato y de su fecha de terminación', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 66' },
      { n: 2, name: 'Relato completo de los hechos que configuran la causal, no la sola cita del numeral', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 66' },
      { n: 3, name: 'Causal invocada del art. 62, expresada en el momento de la extinción', mandatory: true, basis: 'Código Sustantivo del Trabajo, arts. 62 y 66' },
      { n: 4, name: 'Constancia del procedimiento disciplinario previo, cuando la causal supone falta del trabajador', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115' },
      { n: 5, name: 'Verificación de que el trabajador no está amparado por fuero de maternidad, paternidad, sindical o de salud', mandatory: true, basis: 'Código Sustantivo del Trabajo, arts. 239 y 240' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/codigo_sustantivo_trabajo_pr001.html'
  },
  {
    id: 'laboral/liquidacion-definitiva-de-prestaciones-sociales',
    exactName: 'Liquidación definitiva de prestaciones sociales',
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Código Sustantivo del Trabajo, art. 65, modificado por el art. 29 de la Ley 789 de 2002 (con apartes declarados inexequibles y un régimen distinto para quien devenga menos de un salario mínimo)',
    competentAuthority: 'Ninguna: el empleador liquida y paga a la terminación del contrato. El cobro posterior va al juez laboral',
    term: { status: 'VERIFICADO', description: 'VEINTICUATRO (24) MESES, Y ES UN RELOJ DEL TRABAJADOR QUE CASI NADIE LEE COMO TAL PORQUE VIVE DENTRO DE UN ARTÍCULO SOBRE LA SANCIÓN AL EMPLEADOR. La indemnización moratoria es «una suma igual al último salario diario por cada día de retardo, HASTA POR VEINTICUATRO (24) MESES, o hasta cuando el pago se verifique si el período es menor. SI TRANSCURRIDOS VEINTICUATRO (24) MESES contados desde la fecha de terminación del contrato, EL TRABAJADOR NO HA INICIADO SU RECLAMACIÓN POR LA VÍA ORDINARIA o si presentara la demanda, no ha habido pronunciamiento judicial, el empleador deberá pagar al trabajador INTERESES MORATORIOS a la tasa máxima de créditos de libre asignación […] a partir de la iniciación del mes veinticinco (25) hasta cuando el pago se verifique». Es decir: quien demanda dentro de los dos años conserva un salario diario por cada día de retardo; quien deja pasar los dos años cae a intereses, que valen mucho menos. DOS REGÍMENES SEGÚN EL SALARIO, y confundirlos cuesta dinero: para quien devenga MENOS de un salario mínimo mensual sigue vigente el texto ORIGINAL del art. 65, sin el tope de veinticuatro meses; el texto de la Ley 789 de 2002, con el tope, aplica a los demás. EXCEPCIÓN QUE EL EMPLEADOR DEBE INVOCAR: la sanción no procede en «los casos de retención autorizados por la ley o convenidos por las partes».' },
    requiredSections: [
      { n: 1, name: 'Identificación del contrato, su fecha de inicio y de terminación y el último salario', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 65' },
      { n: 2, name: 'Liquidación discriminada de cesantías, intereses a las cesantías, prima y vacaciones', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 65' },
      { n: 3, name: 'Indemnización por despido sin justa causa, cuando corresponda', mandatory: false, basis: 'Código Sustantivo del Trabajo, art. 64' },
      { n: 4, name: 'Deducciones aplicadas, con el título legal o el acuerdo que las autoriza', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 65' },
      { n: 5, name: 'Constancia de pago a la terminación, de la que corren los veinticuatro (24) meses', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 65' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/codigo_sustantivo_trabajo_pr001.html'
  },
  {
    id: 'laboral/queja-por-acoso-laboral',
    exactName: 'Queja por acoso laboral',
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1010 de 2006, art. 18, modificado por el art. 1 de la Ley 2209 de 2022',
    competentAuthority: 'El comité de convivencia laboral de la empresa; el Inspector del Trabajo; y, para las acciones sancionatorias, el juez laboral. Ninguna de las dos primeras es autoridad judicial',
    term: { status: 'VERIFICADO', description: 'TRES (3) AÑOS DE CADUCIDAD, RELOJ DEL TRABAJADOR, Y ESTE ES EL NÚMERO QUE MÁS SE CITA MAL EN COLOMBIA. «Las acciones derivadas del acoso laboral CADUCARÁN EN TRES (3) AÑOS a partir de la fecha en que hayan ocurrido las conductas a que hace referencia esta ley» (art. 18, modificado por el art. 1 de la Ley 2209 de 2022). EL TEXTO ORIGINAL DECÍA SEIS (6) MESES y sigue circulando en formatos, manuales y respuestas dadas de memoria: quien lo repita hoy le dice a un cliente que su derecho murió cuando le quedan años. Se comprobó en el texto oficial. EL PUNTO DE PARTIDA ES LA CONDUCTA, NO EL DESPIDO NI LA RENUNCIA: los tres años corren «a partir de la fecha en que hayan ocurrido las conductas», de modo que en un acoso prolongado cada conducta tiene su propio vencimiento y conviene fechar cada hecho en la queja, uno por uno, en vez de narrarlos como un período.' },
    requiredSections: [
      { n: 1, name: 'Identificación del quejoso, del presunto acosador y de la relación laboral entre ambos', mandatory: true, basis: 'Ley 1010 de 2006, art. 18' },
      { n: 2, name: 'Relato de las conductas CON SU FECHA una por una, de la que corren los tres (3) años de cada una', mandatory: true, basis: 'Ley 1010 de 2006, art. 18' },
      { n: 3, name: 'Encuadre de las conductas en las modalidades de acoso de la ley', mandatory: true, basis: 'Ley 1010 de 2006, arts. 2 y 7' },
      { n: 4, name: 'Pruebas que se aportan: mensajes, testigos, documentos y antecedentes médicos', mandatory: true, basis: 'Ley 1010 de 2006, art. 18' },
      { n: 5, name: 'Autoridad ante la que se presenta: comité de convivencia, Inspector del Trabajo o juez laboral', mandatory: true, basis: 'Ley 1010 de 2006, art. 18' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/ley_1010_2006.html'
  },
  {
    id: 'laboral/solicitud-de-permiso-al-inspector-del-trabajo-para-despedir-a-trabajador-con-fuero-de-maternidad-o-paternidad',
    exactName: 'Solicitud de permiso al Inspector del Trabajo para despedir a trabajador con fuero de maternidad o paternidad',
    branch: 'LABORAL',
    role: 'LITIGANTE',
    legalBasis: 'Código Sustantivo del Trabajo, art. 240, modificado por el art. 2 de la Ley 2141 de 2021, y art. 239, modificado por el art. 2 de la Ley 1822 de 2017 y el art. 1 de la Ley 2141 de 2021',
    competentAuthority: 'El Inspector del Trabajo, o el Alcalde Municipal donde no exista aquel funcionario. NO es autoridad judicial. Si decide el alcalde, «su providencia tiene carácter provisional y debe ser revisada por el Inspector del Trabajo residente en el lugar más cercano»',
    term: { status: 'VERIFICADO', description: 'NO ES UN PLAZO SINO UN REQUISITO DE VALIDEZ: SIN LA AUTORIZACIÓN EL DESPIDO NO VALE, POR JUSTA QUE SEA LA CAUSA. «Ninguna trabajadora podrá ser despedida por motivo de embarazo o lactancia SIN LA AUTORIZACIÓN PREVIA DEL MINISTERIO DE TRABAJO que avale una justa causa» (art. 239 num. 1). LA VENTANA PROTEGIDA ES DE DIECIOCHO (18) SEMANAS POSPARTO, no doce: «Se PRESUME el despido efectuado por motivo de embarazo o lactancia, cuando este haya tenido lugar dentro del período de embarazo y/o dentro de las DIECIOCHO (18) SEMANAS POSTERIORES AL PARTO» (art. 239 num. 2, modificado por la Ley 2141 de 2021). Es una presunción: la carga de desvirtuarla es del empleador. EL FUERO NO ES SOLO DE ELLA, Y ESTO SE PASA POR ALTO TODO EL TIEMPO: «La misma autorización se requerirá para despedir AL TRABAJADOR CUYA CÓNYUGE, PAREJA O COMPAÑERA PERMANENTE SE ENCUENTRE EN ESTADO DE EMBARAZO Y NO TENGA UN EMPLEO FORMAL, adjuntando prueba que así lo acredite o que se encuentre afiliada como beneficiaria en el Sistema de Seguridad Social en Salud» (art. 240 num. 1). COSTO DE DESPEDIR SIN PERMISO: «tendrán derecho al pago adicional de una INDEMNIZACIÓN IGUAL A SESENTA (60) DÍAS DE TRABAJO, fuera de las indemnizaciones y prestaciones a que hubiere lugar» (art. 239 num. 3). QUÉ PUEDE INVOCARSE Y QUÉ NO: «El permiso de que trata este artículo SÓLO PUEDE CONCEDERSE con el fundamento en alguna de las causas que tiene el empleador para dar por terminado el contrato de trabajo y que se enumeran en los artículos 62 y 63. ANTES DE RESOLVER, EL FUNCIONARIO DEBE OÍR A LA TRABAJADORA y practicar todas las pruebas conducentes solicitadas por las partes» (art. 240 num. 2). No sirve la terminación sin justa causa ni la reestructuración.' },
    requiredSections: [
      { n: 1, name: 'Identificación del empleador, del trabajador y del contrato', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 240' },
      { n: 2, name: 'Causal de los arts. 62 o 63 que se invoca, con los hechos que la configuran', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 240 num. 2' },
      { n: 3, name: 'Pruebas de la causal y solicitud de las que deban practicarse', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 240 num. 2' },
      { n: 4, name: 'Constancia del procedimiento disciplinario previo del art. 115, cuando la causal supone falta del trabajador', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 115' },
      { n: 5, name: 'Prueba del embarazo de la cónyuge, pareja o compañera y de que no tiene empleo formal, cuando se trata del fuero de paternidad', mandatory: false, basis: 'Código Sustantivo del Trabajo, art. 240 num. 1' },
      { n: 6, name: 'Dirección del trabajador para que el funcionario lo oiga antes de resolver', mandatory: true, basis: 'Código Sustantivo del Trabajo, art. 240 num. 2' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/codigo_sustantivo_trabajo_pr008.html'
  },
  {
    id: 'laboral/notificacion-por-estado-electronico-en-el-proceso-laboral',
    exactName: 'Notificación por estado electrónico en el proceso laboral',
    branch: 'LABORAL',
    role: 'SECRETARIA',
    legalBasis: 'Ley 2452 de 2025, art. 208 num. 4; art. 82 (traslados); art. 214 (ejecutoria)',
    competentAuthority: 'El secretario del juzgado laboral o de la sala laboral',
    term: { status: 'VERIFICADO', description: 'EL ESTADO YA NO LO FIRMA EL SECRETARIO, Y ESTE ES EL CAMBIO QUE MÁS PLANTILLAS DEJA OBSOLETAS: «Las notificaciones por estado se fijarán VIRTUALMENTE, con inserción de la providencia, y NO SERÁ NECESARIO IMPRIMIRLOS, NI FIRMARLOS POR EL SECRETARIO, NI DEJAR CONSTANCIA CON FIRMA AL PIE de la providencia respectiva» (art. 208). Cualquier formato que exija la firma del secretario al pie viene de la ley derogada. QUÉ SE NOTIFICA POR ESTADO: los autos dictados fuera de audiencia; las sentencias de casación, revisión y anulación y demás de la Sala Laboral de la Corte Suprema y de las salas laborales de tribunales; las sentencias que resuelven apelación Y LA CONSULTA; y las proferidas por escrito conforme al art. 259. TRES CLASES DE PROVIDENCIA NO SE INSERTAN y hay que buscarlas en el expediente: las que decretan medidas cautelares, las que mencionan menores y las sujetas a reserva legal. LO QUE EL ESTADO DISPARA, Y ES SU VALOR REAL: los TRES (3) DÍAS de traslado ordinario del art. 82, que corren «desde el día siguiente a la notificación por estados»; y los TRES (3) DÍAS de ejecutoria de las providencias dictadas fuera de audiencia (art. 214). Ambos son relojes de la parte. EL TRASLADO NO NECESITA AUTO NI CONSTANCIA: «todo traslado que deba surtirse POR FUERA DE AUDIENCIA se realizará POR ESTADOS, por el término de tres (3) días y NO REQUERIRÁ AUTO NI CONSTANCIA EN EL EXPEDIENTE» (art. 82) — quien espere una providencia que le avise, no la va a recibir. Los ejemplares se conservan en línea para consulta permanente.' },
    requiredSections: [
      { n: 1, name: 'Identificación del proceso y de la providencia, con inserción de su texto', mandatory: true, basis: 'Ley 2452 de 2025, art. 208' },
      { n: 2, name: 'Fecha de la providencia y fecha del estado', mandatory: true, basis: 'Ley 2452 de 2025, art. 208' },
      { n: 3, name: 'Verificación de que la providencia no es de las excluidas: cautelares, menores o reserva legal', mandatory: true, basis: 'Ley 2452 de 2025, art. 208' },
      { n: 4, name: 'Publicación virtual, sin impresión ni firma del secretario', mandatory: true, basis: 'Ley 2452 de 2025, art. 208' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/ley_2452_2025.html'
  },
  {
    id: 'laboral/certificacion-de-ejecutoria-de-providencia-laboral',
    exactName: 'Certificación de ejecutoria de providencia laboral',
    branch: 'LABORAL',
    role: 'SECRETARIA',
    legalBasis: 'Ley 2452 de 2025, art. 84 (certificaciones), art. 83 num. 2 (copias como título ejecutivo) y art. 214 (ejecutoria)',
    competentAuthority: 'El secretario del juzgado, que la expide sin providencia que la ordene',
    term: { status: 'VERIFICADO', description: 'LA CERTIFICACIÓN NO TIENE PLAZO PROPIO Y SE EXPIDE SIN AUTO, PERO ES LA LLAVE DE TODO LO QUE VIENE DESPUÉS. «EL SECRETARIO, por solicitud verbal o escrita, puede expedir certificaciones sobre la existencia de procesos, el estado de los mismos y LA EJECUTORIA DE PROVIDENCIAS JUDICIALES, SIN NECESIDAD DE AUTO QUE LAS ORDENE» (art. 84). PARA QUÉ SIRVE, Y ES LO QUE LA HACE INDISPENSABLE: «las copias que se pretendan usar como TÍTULO EJECUTIVO REQUIEREN CONSTANCIA DE SU EJECUTORIA» (art. 83 num. 2). Sin ella, la sentencia ganada no se puede ejecutar. TRES REGÍMENES DE EJECUTORIA QUE LA CERTIFICACIÓN DEBE DISTINGUIR (art. 214): las providencias dictadas EN AUDIENCIA quedan ejecutoriadas UNA VEZ NOTIFICADAS, cuando no se impugnan o no admiten recursos — ejecutoria instantánea; las dictadas FUERA DE AUDIENCIA, TRES (3) DÍAS después de notificadas; y si se pidió oportunamente aclaración, complementación, adición o corrección, SOLO QUEDAN EJECUTORIADAS UNA VEZ RESUELTA LA SOLICITUD. LA TRAMPA QUE HAY QUE VERIFICAR ANTES DE CERTIFICAR, y es propia de esta rama: si la sentencia está sujeta al grado jurisdiccional de consulta, NO HAY EJECUTORIA. El parágrafo del art. 231 no deja margen: «MIENTRAS NO SE SURTA EL GRADO JURISDICCIONAL DE CONSULTA, LA PROVIDENCIA NO QUEDARÁ EJECUTORIADA.» Certificar la ejecutoria de una sentencia consultable es certificar algo que no ha ocurrido.' },
    requiredSections: [
      { n: 1, name: 'Identificación de la providencia y de la fecha y forma de su notificación', mandatory: true, basis: 'Ley 2452 de 2025, art. 214' },
      { n: 2, name: 'Determinación del régimen aplicable: en audiencia, fuera de audiencia, o con solicitud de aclaración pendiente', mandatory: true, basis: 'Ley 2452 de 2025, art. 214' },
      { n: 3, name: 'Verificación de que la sentencia no está sujeta al grado jurisdiccional de consulta', mandatory: true, basis: 'Ley 2452 de 2025, art. 231 par.' },
      { n: 4, name: 'Constancia de que no se interpusieron recursos o de que los interpuestos quedaron resueltos y en firme', mandatory: true, basis: 'Ley 2452 de 2025, art. 214' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/ley_2452_2025.html'
  },
  {
    id: 'laboral/remision-del-expediente-al-superior-en-el-proceso-laboral',
    exactName: 'Remisión del expediente al superior en el proceso laboral',
    branch: 'LABORAL',
    role: 'SECRETARIA',
    legalBasis: 'Ley 2452 de 2025, art. 230 (apelación, traslado y remisión), art. 229 (efectos) y art. 231 (grado jurisdiccional de consulta)',
    competentAuthority: 'El secretario del juzgado de primera instancia, que remite a la sala laboral del tribunal o a la Corte Suprema',
    term: { status: 'VERIFICADO', description: 'CINCO (5) DÍAS DESDE LA EJECUTORIA DEL AUTO QUE CONCEDE, Y EL RELOJ ES EXPRESAMENTE DEL SECRETARIO — no hay equivalente en el procedimiento penal. «EL SECRETARIO DEBERÁ REMITIR LA ACTUACIÓN AL SUPERIOR DENTRO DEL TÉRMINO MÁXIMO DE CINCO (5) DÍAS CONTADOS A PARTIR DE LA EJECUTORIA DEL AUTO QUE CONCEDE EL RECURSO» (art. 230). LO QUE OCURRE ANTES Y SÍ ES RELOJ DEL CLIENTE: la apelación se interpone oralmente en la audiencia donde se profiere la providencia, sustentándose allí mismo si es auto y POR ESCRITO DENTRO DE LOS CINCO (5) DÍAS SIGUIENTES si es sentencia; o por escrito dentro de los TRES (3) DÍAS cuando la providencia se notifica fuera de audiencia, término dentro del cual también debe sustentarse. Sustentación insuficiente o extemporánea: «el juez de primera instancia LO DECLARA DESIERTO». Sustentado, «se correrá traslado POR SECRETARÍA a las partes no recurrentes, por el mismo término», y vencido, el juez decide sobre la concesión y el efecto dentro de los TRES (3) DÍAS siguientes. VACÍO NORMATIVO QUE HAY QUE DECLARAR Y NO RELLENAR: la Ley 2452 NO FIJA PLAZO DE REMISIÓN AL SUPERIOR EN EL GRADO DE CONSULTA. Los cinco días del art. 230 cuelgan de «la ejecutoria del auto que CONCEDE EL RECURSO», y en la consulta no hay recurso ni auto que lo conceda. Se comprobó por barrido de la ley: no existe. LA CONSULTA YA NO ES SOLO A FAVOR DEL TRABAJADOR: son siete supuestos del art. 231 —incluidas las sentencias meramente declarativas, las que niegan honorarios y los fallos inhibitorios— y sube sola, sin que nadie apele. Omitirla es CAUSAL DE NULIDAD (art. 92 num. 8), y mientras no se surta la providencia no queda ejecutoriada.' },
    requiredSections: [
      { n: 1, name: 'Identificación del auto que concedió el recurso, de su efecto y de su fecha de ejecutoria', mandatory: true, basis: 'Ley 2452 de 2025, arts. 229 y 230' },
      { n: 2, name: 'Constancia de que se surtió el traslado por secretaría a las partes no recurrentes', mandatory: true, basis: 'Ley 2452 de 2025, art. 230' },
      { n: 3, name: 'Verificación de si la sentencia debe subir en grado de consulta, aunque no haya sido apelada', mandatory: true, basis: 'Ley 2452 de 2025, art. 231' },
      { n: 4, name: 'Indicación de las decisiones que quedan ejecutoriadas, cuando la apelación es parcial', mandatory: true, basis: 'Ley 2452 de 2025, art. 229' },
      { n: 5, name: 'Constancia de remisión dentro de los cinco (5) días siguientes a la ejecutoria', mandatory: true, basis: 'Ley 2452 de 2025, art. 230' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/ley_2452_2025.html'
  },
  {
    id: 'laboral/notificacion-personal-por-medios-electronicos-en-el-proceso-laboral',
    exactName: 'Notificación personal por medios electrónicos en el proceso laboral',
    branch: 'LABORAL',
    role: 'SECRETARIA',
    legalBasis: 'Ley 2452 de 2025, arts. 208 num. 1, 209 (notificación personal electrónica), 211 (por medios físicos), 210 (aviso) y 212 (conducta concluyente)',
    competentAuthority: 'El secretario del juzgado laboral, que envía y deja la constancia. Para entidades públicas, privadas con funciones públicas, Ministerio Público y ANDJE, al buzón del art. 197 del CPACA',
    term: { status: 'VERIFICADO', description: 'DOS (2) DÍAS HÁBILES PARA QUE LA NOTIFICACIÓN SE ENTIENDA HECHA, PERO LOS TÉRMINOS ARRANCAN DE OTRO MOMENTO — Y ESA DISTINCIÓN ES LA QUE SE PIERDE AL CONTAR. La notificación «SE ENTIENDE REALIZADA una vez transcurridos DOS (2) DÍAS HÁBILES siguientes al envío del mensaje», y sin embargo «los términos EMPEZARÁN A CORRER DESDE EL DÍA SIGUIENTE A LA CONSTATACIÓN DE ENTREGA O ACUSE» (art. 209). Son dos fechas distintas y el catálogo debe separarlas. LA CONSTANCIA NO TIENE PLAZO PROPIO PERO ES LA QUE HACE CORRER TODO: «EL SECRETARIO HARÁ CONSTAR ESTE HECHO EN EL EXPEDIENTE». Sin ella no hay cómputo posible. NO SE REQUIERE CITACIÓN PREVIA: el envío de la providencia como mensaje de datos basta, con el juramento del interesado sobre la dirección, prestado con la presentación de la demanda. SI NO HAY CANAL DIGITAL, la vía es postal y abre los relojes del demandado: comparecencia en CINCO (5) DÍAS en el mismo municipio, DIEZ (10) en municipio distinto y TREINTA (30) en el exterior, y «la empresa postal COTEJARÁ Y SELLARÁ COPIA Y EXPEDIRÁ CONSTANCIA DE ENTREGA; ambos documentos se incorporan al expediente» (art. 211). Imposible la personal, el aviso da DIEZ (10) DÍAS desde su fijación para comparecer, y vencidos vienen curador ad lítem y emplazamiento (art. 210). LA NOTIFICACIÓN QUE OCURRE SIN QUE NADIE LA PRACTIQUE, y sorprende a quien no la conoce: «quien constituya apoderado SE ENTIENDE NOTIFICADO DE TODO EL DÍA EN QUE SE NOTIFIQUE EL AUTO QUE LE RECONOCE PERSONERÍA» (art. 212) — el auto de reconocimiento notifica hacia atrás todas las providencias del proceso, incluido el admisorio.' },
    requiredSections: [
      { n: 1, name: 'Identificación del destinatario y del canal digital al que se envía', mandatory: true, basis: 'Ley 2452 de 2025, art. 209' },
      { n: 2, name: 'Envío de la providencia como mensaje de datos, sin citación previa', mandatory: true, basis: 'Ley 2452 de 2025, art. 209' },
      { n: 3, name: 'Constancia del secretario sobre la entrega o el acuse, de la que corren los términos', mandatory: true, basis: 'Ley 2452 de 2025, art. 209' },
      { n: 4, name: 'Cómputo separado de los dos (2) días hábiles y de la fecha de constatación de entrega', mandatory: true, basis: 'Ley 2452 de 2025, art. 209' },
      { n: 5, name: 'Constancia postal de entrega, cotejo y sello, cuando la notificación es por medios físicos', mandatory: false, basis: 'Ley 2452 de 2025, art. 211' }
    ],
    sourceUrl: 'https://www.secretariasenado.gov.co/senado/basedoc/ley_2452_2025.html'
  }
  ]
