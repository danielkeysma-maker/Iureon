...
export const SOCIETARIO_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'SOCIETARIO',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1116 de 2006, arts. 29 y 48 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1116 de 2006, art. 24, y Código Civil, arts. 2488, 2493, 2496, 2499 y 2509: la objeción se juega sobre la existencia, la cuantía y la prelación del crédito, y la propia ley de insolvencia dice dónde vive esa regla, porque el proyecto de calificación y graduación debe detallar las obligaciones y los acreedores «debidamente clasificados para el caso de los créditos, en los términos del Título XL del Libro Cuarto del Código Civil y demás normas legales que lo modifiquen o adicionen». Allí: toda obligación personal da al acreedor el derecho de perseguir su ejecución sobre todos los bienes raíces o muebles del deudor, presentes o futuros, exceptuados solamente los inembargables; las causas de preferencia son solamente el privilegio y la hipoteca, son inherentes a los créditos para cuya seguridad se establecieron y pasan con ellos a quien los adquiera por cesión, subrogación o de otra manera; los créditos de primera clase afectan todos los bienes del deudor y, si no alcanzan, prefieren unos a otros en el orden de su numeración cualquiera que sea su fecha, concurriendo a prorrata los comprendidos en un mismo número, y no pasan en caso alguno contra terceros poseedores; la tercera clase comprende los hipotecarios, que se pagan según el orden de las fechas de sus hipotecas y, a igual fecha sobre una misma finca, por el orden de su inscripción; y la quinta y última clase comprende los bienes que no gozan de preferencia y se cubre a prorrata sobre el sobrante de la masa concursada, sin consideración a su fecha.',
    competentAuthority: 'El juez del concurso',
