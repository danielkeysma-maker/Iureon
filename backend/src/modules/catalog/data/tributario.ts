...
export const TRIBUTARIO_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'TRIBUTARIO',
    role: 'LITIGANTE',
    legalBasis: 'Estatuto Tributario, arts. 736 a 738 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): el Estatuto Tributario NO trae causales de revocación y remite: su art. 736 dice que «Sólo procederá la revocatoria directa prevista en el Código Contencioso Administrativo, cuando el contribuyente no hubiere interpuesto los recursos por la vía gubernativa», y ese Código —el Decreto 01 de 1984— fue derogado expresamente por el art. 309 de la Ley 1437 de 2011, que lo sustituyó. Las causales, entonces, son las de la Ley 1437 de 2011, art. 93: los actos administrativos DEBERÁN ser revocados, de oficio o a solicitud de parte, 1. cuando sea MANIFIESTA SU OPOSICIÓN A LA CONSTITUCIÓN POLÍTICA O A LA LEY; 2. cuando NO ESTÉN CONFORMES CON EL INTERÉS PÚBLICO O SOCIAL, O ATENTEN CONTRA ÉL; 3. cuando CON ELLOS SE CAUSE AGRAVIO INJUSTIFICADO A UNA PERSONA. Y el art. 94 cierra la puerta a la primera de las tres cuando se pidió a solicitud de parte y el peticionario ya interpuso los recursos, o ya caducó el control judicial: es la misma barrera del art. 736 del E.T., y por eso invocar la causal 1 sin acreditar que no se recurrió es perder la solicitud de entrada.',
    competentAuthority: 'Dirección de Impuestos y Aduanas Nacionales (DIAN)',
