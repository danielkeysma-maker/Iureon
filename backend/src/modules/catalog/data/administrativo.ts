...
export const ADMINISTRATIVO_CATALOG: BranchCatalog = {
  meta: {
    ...
    'ADMINISTRATIVO: Intraprocesales del contencioso administrativo: la aclaración, la corrección y la adición de providencias y de sentencias, la nulidad procesal y el desistimiento de las pretensiones NO se duplicaron en ADMINISTRATIVO. La Ley 1437 de 2011 no las regula y llegan al proceso contencioso administrativo por la remisión del art. 306 —«En los aspectos no contemplados en este Código se seguirá el Código de Procedimiento Civil»—, hoy el Código General del Proceso por su art. 1, de modo que las fichas de la rama CIVIL «Solicitud de aclaración de providencia», «Solicitud de adición de providencia», «Solicitud de corrección de errores aritméticos», «Solicitud de nulidad procesal» y «Desistimiento de las pretensiones» son las aplicables. Lo único que el CPACA sí añade sobre ellas es el art. 243A num. 12: las providencias que niegan la adición o la aclaración no admiten recursos, y «Si se trata de sentencia, se computará nuevamente el término para apelarla».',
