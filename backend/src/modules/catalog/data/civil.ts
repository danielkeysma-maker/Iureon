...
export const CIVIL_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'CIVIL',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1564 de 2012, art. 382 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Código de Comercio, arts. 186, 190, 191 y 192: las decisiones tomadas en una reunión celebrada en contravención al art. 186 —lugar del domicilio social y sujeción a la ley y a los estatutos en convocación y quórum— son ineficaces; las adoptadas sin el número de votos previstos en los estatutos o en las leyes, o excediendo los límites del contrato social, son absolutamente nulas; y las que no tengan carácter general conforme al art. 188 son inoponibles a los socios ausentes o disidentes. Están legitimados para impugnar los administradores, los revisores fiscales y los socios ausentes o disidentes, cuando las decisiones no se ajusten a las prescripciones legales o a los estatutos. RELOJ DEL CLIENTE, y vive en el art. 191 y no en el art. 382 del CGP: la impugnación sólo puede intentarse dentro de los dos (2) meses siguientes a la fecha de la reunión en que se adoptaron las decisiones, o de la fecha de la inscripción cuando se trate de acuerdos o actos que deban inscribirse en el registro mercantil. Declarada la nulidad, los administradores deben tomar, bajo su propia responsabilidad, las medidas necesarias para que se cumpla la sentencia (art. 192).',
