...
export const PROPIEDAD_INTELECTUAL_CATALOG: BranchCatalog = {
  ...
  actuaciones: [
  {
    ...
    branch: 'PROPIEDAD_INTELECTUAL',
    role: 'LITIGANTE',
    legalBasis: 'Decisión Andina 486 de 2000, arts. 138 (contenido de la solicitud), 139 (petitorio), 140 (fecha de presentación), 144 (examen de forma y plazo para subsanar), 145 (publicación); Decreto 4886 de 2011, art. 19 num. 1 (dependencia que decide) — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Decisión Andina 486 de 2000, arts. 134, 135 y 136: constituye marca cualquier signo apto para distinguir productos o servicios en el mercado y son registrables los signos susceptibles de representación gráfica, entre otros las palabras, las imágenes y figuras, los sonidos y olores, las letras y números, un color delimitado por una forma, y la forma de los productos, sus envases o envolturas (art. 134); no pueden registrarse, por causales absolutas, los signos que carezcan de distintividad, los que consistan exclusivamente en formas usuales o funcionales, en indicaciones descriptivas de la calidad, cantidad, destino, valor o procedencia geográfica, en el nombre genérico o técnico del producto, en un color aisladamente considerado, ni los que puedan engañar sobre la procedencia, naturaleza o características del producto (art. 135); y no pueden registrarse, por causales relativas, los signos cuyo uso en el comercio afecte indebidamente un derecho de tercero, en particular los idénticos o semejantes a una marca anteriormente solicitada o registrada, a un nombre comercial, rótulo, enseña o lema comercial protegido, cuando su uso pueda causar riesgo de confusión o de asociación, los que afecten la identidad o prestigio de una persona, los que infrinjan derecho de propiedad industrial o de autor de un tercero y los que reproduzcan, imiten o traduzcan un signo distintivo notoriamente conocido (art. 136).',
  ...
  },
  {
    ...
    competentAuthority: 'Jurisdicción de lo contencioso administrativo. LA COMPETENCIA CONCRETA HAY QUE CONFIRMARLA ANTES DE RADICAR, Y NO ES UN DETALLE: un término exacto ante el despacho equivocado se pierde igual. La Decisión 486 remite en su art. 273 al órgano «designado al efecto por la legislación nacional sobre la materia», y el art. 149 num. 1 del CPACA —modificado por el art. 24 de la Ley 2080 de 2021— atribuye al CONSEJO DE ESTADO en única instancia la nulidad de los actos administrativos del orden nacional «SALVO QUE SE TRATE DE ACTOS DE CERTIFICACIÓN O REGISTRO, respecto de los cuales la competencia está radicada en los TRIBUNALES ADMINISTRATIVOS». Del solo texto no se resuelve si el acto que concede un registro marcario cae en esa salvedad. Se consigna el Consejo de Estado, Sección Primera, por ser la práctica conocida, pero es una práctica, no una lectura del artículo.',
    term: { status: 'VERIFICADO', description: 'DOS ACCIONES CON RELOJES OPUESTOS. (1) Nulidad ABSOLUTA, cuando el registro se concedió contra el art. 134 primer párrafo o el art. 135: «La autoridad nacional competente decretará de oficio o a solicitud de cualquier persona y EN CUALQUIER MOMENTO, la nulidad absoluta de un registro de marca» (art. 172). No prescribe. (2) Nulidad RELATIVA, cuando se concedió contra el art. 136 o el registro se obtuvo de mala fe: «Esta acción prescribirá a los CINCO AÑOS contados desde la fecha de concesión del registro impugnado» (art. 172). Ése es el reloj que mata el derecho del cliente y se cuenta desde la concesión, no desde que se supo del registro. Las acciones de nulidad no afectan las que correspondan por daños y perjuicios conforme a la legislación interna, y no puede declararse la nulidad por causales que hubiesen dejado de ser aplicables al tiempo de resolverse (art. 172).' },
    requiredSections: [
  ...
  },
  {
    ...
    branch: 'PROPIEDAD_INTELECTUAL',
    role: 'LITIGANTE',
    legalBasis: 'Decisión Andina 486 de 2000, arts. 26 (contenido), 27 (petitorio), 28 (descripción), 33 (fecha de presentación), 38 y 39 (examen de forma y plazo para subsanar), 40 (publicación a los dieciocho meses), 44 (petición del examen de patentabilidad so pena de abandono), 45 (respuesta al examen), 48 (decisión), 50 (duración de veinte años) — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Decisión Andina 486 de 2000, arts. 14, 15, 16, 18, 19, 20 y 21: se patentan las invenciones, de producto o de procedimiento, en todos los campos de la tecnología, siempre que sean nuevas, tengan nivel inventivo y sean susceptibles de aplicación industrial (art. 14); no se consideran invenciones los descubrimientos, las teorías científicas y los métodos matemáticos, el todo o parte de seres vivos tal como se encuentran en la naturaleza, las obras protegidas por el derecho de autor, los planes, reglas y métodos para actividades intelectuales, juegos o actividades económico-comerciales, los programas de ordenador como tales y las formas de presentar información (art. 15); una invención es nueva cuando no está comprendida en el estado de la técnica, que comprende todo lo accesible al público por descripción escrita u oral, utilización, comercialización o cualquier otro medio antes de la fecha de presentación de la solicitud o de la prioridad reconocida (art. 16); tiene nivel inventivo si para una persona del oficio normalmente versada en la materia técnica no hubiese resultado obvia ni se hubiese derivado de manera evidente del estado de la técnica (art. 18); es susceptible de aplicación industrial cuando su objeto pueda ser producido o utilizado en cualquier tipo de industria (art. 19); no son patentables las invenciones cuya explotación comercial deba impedirse para proteger el orden público o la moral, o la salud o la vida de las personas o de los animales, o para preservar los vegetales o el medio ambiente, ni las plantas, los animales y los procedimientos esencialmente biológicos para su producción, ni los métodos terapéuticos o quirúrgicos de tratamiento humano o animal ni los métodos de diagnóstico (art. 20); y los productos o procedimientos ya patentados comprendidos en el estado de la técnica no son objeto de nueva patente por el simple hecho de atribuirse un uso distinto al originalmente comprendido (art. 21).',
  ...
  },
  {
    ...
    competentAuthority: 'Autoridad aduanera nacional, ante la cual se pide suspender la operación de importación o exportación (Decisión 486, art. 250). LA DIRECCIÓN ESTÁ INCOMPLETA Y HAY QUE PRECISARLA ANTES DE RADICAR: el propio art. 250 remite a «las condiciones y garantías que establezcan las normas internas del País Miembro», y el Decreto 4540 de 2006 —que regula la intervención de la autoridad aduanera sobre mercancía presuntamente falsificada o pirata— NO PUDO LEERSE EN FUENTE OFICIAL: funcionpublica devolvió «No disponible» y suin-juriscol no respondió. Por eso no se afirma cuál dependencia de la DIAN recibe la solicitud, ni si el Estatuto Aduanero vigente (Decreto 1165 de 2019) desplazó ese decreto. La acción por infracción, en cambio, sí está clara: se inicia ante la Superintendencia de Industria y Comercio o el juez civil (Ley 1564 de 2012, art. 24 num. 3 lit. a).',
    term: { status: 'VERIFICADO', description: 'EL RELOJ DEL TITULAR ES DE DIEZ DÍAS HÁBILES Y SU VENCIMIENTO LIBERA LA MERCANCÍA: «Transcurridos DIEZ DÍAS HÁBILES contados desde la fecha de notificación de la suspensión de la operación aduanera sin que el demandante hubiere iniciado la acción por infracción, o sin que la autoridad nacional competente hubiere prolongado la suspensión, la medida se levantará y se procederá al despacho de las mercancías retenidas» (art. 253). Se cuenta desde la NOTIFICACIÓN de la suspensión, no desde la solicitud. Legitimación: «El titular de un registro de marca, que tuviera motivos fundados para suponer que se va a realizar la importación o la exportación de productos que infringen ese registro, podrá solicitar a la autoridad nacional competente suspender esa operación aduanera» (art. 250). Iniciada la acción, la parte contra quien obró la medida puede recurrir, y la autoridad puede modificar, revocar o confirmar la suspensión (art. 254). Quedan excluidas las cantidades pequeñas sin carácter comercial que formen parte del equipaje personal de los viajeros o se envíen en pequeñas partidas (art. 256).' },
    requiredSections: [
