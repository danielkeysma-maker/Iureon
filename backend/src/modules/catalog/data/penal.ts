...
export const PENAL_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    term: { status: 'VERIFICADO', description: 'La persona capturada debe ser puesta a disposición del juez de control de garantías en el plazo máximo de treinta y seis (36) horas para la audiencia de control de legalidad (art. 297). Añadir el supuesto de flagrancia, que la ficha no cubre: cuando la captura es en flagrancia el plazo de treinta y seis (36) horas se rige por el inciso 5º del art. 302 y corre desde la aprehensión, y la Fiscalía es quien debe presentar al capturado ante el juez de control de garantías. Excepción de conteo: si la captura en flagrancia se produce en ríos o en tierra donde el arribo a la cabecera municipal más cercana solo puede surtirse por vía fluvial, o concurren dificultades objetivas de acceso al territorio acreditadas, las treinta y seis (36) horas se cuentan a partir de la llegada al puerto o municipio más cercano (art. 302, inciso adicionado por el art. 6 de la Ley 2111 de 2021).' },
    requiredSections: [
  ...
  },
  {
    ...
    competentAuthority: 'Juez de conocimiento',
    term: { status: 'VERIFICADO', description: 'Si transcurren ciento cincuenta (150) días desde el inicio de la audiencia de juicio sin que se celebre la audiencia de lectura de fallo, procede la libertad por vencimiento de términos (art. 317 num. 6). Añadir el término propio de la actuación, que la ficha no traía. El sentido del fallo se da a conocer de manera oral y pública inmediatamente después del receso previsto en el art. 445, individualizado frente a cada enjuiciado y cada cargo (art. 446). Anunciado el fallo condenatorio, o aceptado el acuerdo con la Fiscalía, el juez oye brevemente y por una sola vez al fiscal y a la defensa sobre las condiciones individuales, familiares, sociales, modo de vivir y antecedentes del culpable, y señala la audiencia para proferir sentencia en un término que no podrá exceder de quince (15) días contados a partir de la terminación del juicio oral; el mismo término rige para la sentencia absolutoria (art. 447). Si el juez estima necesario ampliar la información, el experto designado debe responder en el término improrrogable de diez (10) días hábiles. Ese plazo de quince (15) días es el reloj del juez de conocimiento. El plazo de ciento cincuenta (150) días desde el inicio de la audiencia de juicio sin audiencia de lectura de fallo o su equivalente es un reloj distinto y a favor del procesado: no obliga al juez a fallar, sino que da lugar a la libertad por vencimiento de términos (art. 317 num. 6, modificado por el art. 6 de la Ley 2477 de 2025). El acusado no podrá ser declarado culpable por hechos que no consten en la acusación ni por delitos por los cuales no se ha solicitado condena (art. 448).' },
    requiredSections: [
