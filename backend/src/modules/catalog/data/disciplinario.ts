...
export const DISCIPLINARIO_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    term: { status: 'NO_VERIFICADO', description: 'EL AUTO NO TIENE PLAZO PROPIO, PERO ES EL QUE DISPARA EL RELOJ DEL DISCIPLINADO, Y SEGÚN LO QUE DECIDA ESE RELOJ ES DE QUINCE DÍAS O DE DIEZ. «Recibido el expediente por el funcionario a quien corresponda el juzgamiento, por auto de sustanciación motivado, decidirá […] SI EL JUZGAMIENTO SE ADELANTA POR EL JUICIO ORDINARIO O POR EL VERBAL. CONTRA ESTA DECISIÓN NO PROCEDE RECURSO ALGUNO» (art. 225A). SI ELIGE EL ORDINARIO, el disciplinado tiene QUINCE (15) DÍAS: «dispondrá que, por el término de quince (15) días, el expediente quede a disposición de los sujetos procesales en la secretaría. En este plazo, PODRÁN PRESENTAR DESCARGOS, así como aportar y solicitar pruebas» (art. 225B). SI ELIGE EL VERBAL, no hay traslado sino audiencia, «la cual se realizará en un término NO MENOR A LOS DIEZ (10) DÍAS NI MAYOR A LOS VEINTE (20) DÍAS de la fecha del auto de citación» (art. 225H). POR QUÉ IMPORTA TANTO Y NO SE PUEDE PELEAR: el verbal deja mucho menos tiempo de preparación y concentra todo en una audiencia, y la elección no admite recurso alguno — así que la defensa se prepara desde que llega el auto, no desde la citación. ADVERTENCIA QUE HAY QUE DARLE AL CLIENTE: «La renuencia del investigado o su defensor a presentar descargos NO INTERRUMPEN EL TRÁMITE de la actuación» — callar no detiene nada.' },
    requiredSections: [
