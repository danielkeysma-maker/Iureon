...
export const AMBIENTAL_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'AMBIENTAL',
    role: 'DESPACHO',
    legalBasis: 'Decreto 1076 de 2015, art. 2.2.2.3.6.3 nums. 2 y 3 y par. 4; art. 2.2.2.3.8.1 num. 3 (modificación); Ley 1437 de 2011, arts. 74 y 76 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Decreto 1076 de 2015, art. 2.2.2.3.6.3 nums. 2 y 3, y Ley 1437 de 2011, art. 17: la causal del archivo es que el solicitante no allegue, dentro del mes que se le concedió —prorrogable por un término igual solo si la prórroga se pide antes del vencimiento—, la información adicional que la autoridad ambiental le requirió por una única vez en la reunión prevista en el numeral 2, caso en el cual la autoridad ordena el archivo de la solicitud y la devolución de la totalidad de la documentación aportada mediante acto administrativo motivado; el propio numeral 2 remite al art. 17 de la Ley 1437 de 2011, según el cual se entiende que el peticionario ha desistido de su solicitud o de la actuación cuando no satisface el requerimiento, salvo que antes de vencer el plazo concedido solicite prórroga hasta por un término igual, y vencidos esos términos sin cumplirlo la autoridad decreta el desistimiento y el archivo del expediente mediante acto administrativo motivado que se notifica personalmente y contra el cual únicamente procede recurso de reposición, sin perjuicio de que la solicitud pueda presentarse de nuevo con el lleno de los requisitos legales.',
