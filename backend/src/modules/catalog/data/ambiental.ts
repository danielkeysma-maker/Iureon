...
export const AMBIENTAL_CATALOG: BranchCatalog = {
  meta: {
    ...
    'AMBIENTAL: Recurso de apelación en vía gubernativa contra el acto sancionatorio ambiental: NO se catalogó como ficha propia. La Ley 1333, art. 30, solo lo hace procedente \'siempre que exista superior jerárquico\' y remite al CPACA; el escrito es el de ADMINISTRATIVO, \'Recurso de apelación (vía gubernativa)\'. La regla ambiental -que muchas autoridades ambientales carecen de superior jerárquico, de modo que la reposición agota la vía- quedó incorporada al término de la ficha de reposición.',
