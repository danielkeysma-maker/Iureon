...
export const CONTRATACION_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'CONTRATACION',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1474 de 2011, art. 86 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1150 de 2007, art. 17: la entidad solo puede imponer las multas QUE HAYAN SIDO PACTADAS y con el objeto de conminar al contratista a cumplir sus obligaciones, la decisión debe estar precedida de audiencia del afectado y procede SÓLO MIENTRAS SE HALLE PENDIENTE LA EJECUCIÓN de las obligaciones a su cargo; la declaratoria de incumplimiento procede con el propósito de hacer efectiva la cláusula penal pecuniaria incluida en el contrato. Ley 80 de 1993, arts. 14 y 18: las potestades excepcionales tienen por exclusivo objeto evitar la paralización o la afectación grave del servicio público y solo caben en los contratos del num. 2 del art. 14 (numeral modificado por el art. 52 de la Ley 2195 de 2022), donde se entienden pactadas aunque no se consignen; y la caducidad exige un hecho constitutivo de incumplimiento de las obligaciones a cargo del contratista QUE AFECTE DE MANERA GRAVE Y DIRECTA la ejecución del contrato Y EVIDENCIE QUE PUEDE CONDUCIR A SU PARALIZACIÓN. Esos cuatro requisitos —multa pactada, ejecución pendiente, gravedad y aptitud paralizante— son lo que los descargos deben desvirtuar.',
    competentAuthority: 'Entidad estatal contratante',
  ...
  },
  {
    ...
    branch: 'CONTRATACION',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1150 de 2007, art. 11 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 80 de 1993, art. 60 (modificado por el art. 217 del Decreto 19 de 2012): son objeto de liquidación los contratos de tracto sucesivo, aquellos cuya ejecución o cumplimiento se prolongue en el tiempo y los demás que lo requieran —no lo son, por mandato del mismo artículo, los de prestación de servicios profesionales y de apoyo a la gestión—; en esa etapa las partes acuerdan LOS AJUSTES, REVISIONES Y RECONOCIMIENTOS A QUE HAYA LUGAR, y en el acta constan los acuerdos, conciliaciones y transacciones con que ponen fin a las divergencias para poder declararse a paz y salvo; para liquidar se exige al contratista extender o ampliar la garantía a la estabilidad de la obra, la calidad del bien o servicio, la provisión de repuestos, el pago de salarios, prestaciones e indemnizaciones y la responsabilidad civil. Ley 1150 de 2007, art. 11, inciso final: el contratista TIENE DERECHO A EFECTUAR SALVEDADES a la liquidación por mutuo acuerdo, y solo respecto de los aspectos que no hayan sido objeto de acuerdo procede después la liquidación unilateral: lo que se firma sin salvedad se pierde.',
    competentAuthority: 'Entidad estatal contratante',
  ...
  },
  {
    ...
    branch: 'CONTRATACION',
    role: 'DESPACHO',
    legalBasis: 'Ley 80 de 1993, art. 30 nums. 10 y 11; Ley 1150 de 2007, art. 9 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1150 de 2007, art. 5: es objetiva la selección en la cual la escogencia se haga al OFRECIMIENTO MÁS FAVORABLE a la entidad y a los fines que ella busca, sin tener en consideración factores de afecto o de interés ni cualquier clase de motivación subjetiva. De ahí salen los cuatro criterios que la motivación debe acreditar: la capacidad jurídica y las condiciones de experiencia, capacidad financiera y de organización son REQUISITOS HABILITANTES que se verifican y NO OTORGAN PUNTAJE (num. 1); la oferta más favorable es la que, con los factores técnicos y económicos y su ponderación precisa y detallada contenida en el pliego, resulte la más ventajosa, SIN QUE LA FAVORABILIDAD LA CONSTITUYAN FACTORES DIFERENTES A LOS CONTENIDOS EN DICHOS DOCUMENTOS, y en obra pública el menor plazo ofrecido no es evaluable (num. 2, modificado por el art. 88 de la Ley 1474 de 2011); en bienes y servicios de características técnicas uniformes y común utilización el ÚNICO factor de evaluación es el menor precio (num. 3); y en consultoría se califica lo técnico y EN NINGÚN CASO puede incluirse el precio como factor de escogencia (num. 4). La ausencia de requisitos no necesarios para comparar las propuestas no sirve de título para rechazar la oferta, y lo subsanable debe pedirse hasta el traslado del informe de evaluación (parágrafo 1o, modificado por el art. 5 de la Ley 1882 de 2018), salvo la garantía de seriedad, cuya no entrega con la propuesta NO es subsanable y es causal de rechazo (parágrafo 3o). El art. 29 de la Ley 80 de 1993, que llevaba la rúbrica «DEL DEBER DE SELECCIÓN OBJETIVA», está DEROGADO por el art. 32 de la Ley 1150 de 2007.',
    competentAuthority: 'Entidad estatal contratante',
  ...
  },
  {
    ...
    branch: 'CONTRATACION',
    role: 'DESPACHO',
    legalBasis: 'Ley 1474 de 2011, art. 86 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1150 de 2007, art. 17: la facultad se limita a las multas QUE HAYAN SIDO PACTADAS, tiene por objeto conminar al contratista a cumplir, exige audiencia previa del afectado y procede SÓLO MIENTRAS SE HALLE PENDIENTE LA EJECUCIÓN de las obligaciones a su cargo; la declaratoria de incumplimiento se hace con el propósito de hacer efectiva la cláusula penal pecuniaria INCLUIDA EN EL CONTRATO, y la multa y la cláusula penal así impuestas se hacen efectivas directamente por la entidad, entre otros por compensación de las sumas adeudadas al contratista, cobro de la garantía o jurisdicción coactiva (parágrafo). Código Civil, art. 1592: la cláusula penal es aquella en que una persona, para asegurar el cumplimiento de una obligación, se sujeta a una pena que consiste en dar o hacer algo en caso de no ejecutar o retardar la obligación principal; de ahí que sin pacto no hay pena que imponer. Ley 80 de 1993, art. 18: cuando lo que se declara es la caducidad, el incumplimiento debe AFECTAR DE MANERA GRAVE Y DIRECTA la ejecución del contrato Y EVIDENCIAR QUE PUEDE CONDUCIR A SU PARALIZACIÓN.',
    competentAuthority: 'Entidad estatal contratante',
  ...
  },
  {
    ...
    branch: 'CONTRATACION',
    role: 'DESPACHO',
    legalBasis: 'Ley 1150 de 2007, art. 11 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 80 de 1993, art. 60 (modificado por el art. 217 del Decreto 19 de 2012): son objeto de liquidación los contratos de tracto sucesivo, aquellos cuya ejecución o cumplimiento se prolongue en el tiempo y los demás que lo requieran, y en ella las partes acuerdan los ajustes, revisiones y reconocimientos a que haya lugar; la liquidación NO es obligatoria en los contratos de prestación de servicios profesionales y de apoyo a la gestión. Ley 1150 de 2007, art. 11: el presupuesto de la liquidación unilateral es que EL CONTRATISTA NO SE PRESENTE previa notificación o convocatoria que le haga la entidad, o que LAS PARTES NO LLEGUEN A ACUERDO sobre su contenido; y cuando el contratista dejó salvedades en la liquidación bilateral, la unilateral SOLO PROCEDE respecto de los aspectos que no fueron objeto de acuerdo. El art. 61 de la Ley 80 de 1993, que llevaba la rúbrica «DE LA LIQUIDACIÓN UNILATERAL», está DEROGADO por el art. 32 de la Ley 1150 de 2007 y no puede invocarse.',
    competentAuthority: 'Entidad estatal contratante',
