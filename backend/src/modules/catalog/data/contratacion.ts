...
export const CONTRATACION_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    competentAuthority: 'Entidad estatal contratante',
    term: { status: 'VERIFICADO', description: 'HUECO PARCIALMENTE CERRADO: la ley NO fija un plazo en días para expedir la declaratoria de desierta, pero SÍ fija su marco, que la ficha no citaba — «Dentro del mismo término de adjudicación, podrá declararse desierta la licitación o concurso conforme a lo previsto en este estatuto» (art. 30 num. 9 inc. 3). Ese término de adjudicación lo señala el PLIEGO DE CONDICIONES «teniendo en cuenta su naturaleza, objeto y cuantía», y solo puede prorrogarlo el jefe o representante de la entidad, antes de su vencimiento, «por un término total no mayor a la mitad del inicialmente fijado». Vencido ese término sin acto de adjudicación ni de declaratoria de desierta, la entidad pierde la oportunidad. Causal y motivación: «La declaratoria de desierta de la licitación o concurso únicamente procederá por motivos o causas que impidan la escogencia objetiva y se declarará en acto administrativo en el que se señalarán en forma expresa y detallada las razones que han conducido a esa decisión» (art. 25 num. 18). La expresión «concurso» de ambos artículos fue derogada por el art. 32 de la Ley 1150 de 2007. Sin leer el pliego del proceso concreto no puede afirmarse un número de días: el término existe, pero su medida es contractual, no legal.' },
    requiredSections: [
