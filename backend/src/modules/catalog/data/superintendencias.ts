...
export const SUPERINTENDENCIAS_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'SUPERINTENDENCIAS',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1480 de 2011, art. 58; Ley 1564 de 2012, art. 24 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1480 de 2011, arts. 3, 7, 8, 10, 11, 23 y 30: el consumidor tiene derecho a recibir productos de calidad conforme a la garantía legal, a la seguridad e indemnidad, a recibir información completa, veraz, transparente, oportuna, verificable, comprensible, precisa e idónea, a ser protegido contra la publicidad engañosa y a reclamar reparación integral (art. 3); la garantía legal es la obligación a cargo de todo productor y proveedor de responder por la calidad, idoneidad, seguridad y buen estado y funcionamiento de los productos, y en los servicios con obligación de medio la da la calidad de la prestación y no el resultado (art. 7); a falta de término legal o anunciado la garantía es de un año para productos nuevos, la de los perecederos vence con el producto, la de los usados sin garantía expresa y aceptada por escrito es de tres meses, y en inmuebles cubre la estabilidad de la obra por diez años y los acabados por uno (art. 8); productores y proveedores responden solidariamente y para establecer la responsabilidad basta demostrar el defecto del producto (art. 10); la garantía comprende la reparación gratuita y, si el bien no admite reparación o la falla se repite, a elección del consumidor la nueva reparación, la devolución total o parcial del precio o el cambio del bien, y en servicios la prestación en las condiciones contratadas o la devolución del precio (art. 11); la información suministrada obliga y hace responsable de todo daño que sea consecuencia de información inadecuada o insuficiente (art. 23); la publicidad engañosa está prohibida y el anunciante responde por los perjuicios que cause y por incumplir las condiciones objetivas anunciadas (art. 30).',
  ...
  },
  {
    ...
    branch: 'SUPERINTENDENCIAS',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1480 de 2011, art. 58 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1480 de 2011, arts. 6 y 19: todo productor debe asegurar la idoneidad y seguridad de los bienes y servicios que ofrezca o ponga en el mercado, así como la calidad ofrecida, sin que en ningún caso puedan ser inferiores ni contravenir los reglamentos técnicos y las medidas sanitarias o fitosanitarias, y su incumplimiento genera responsabilidad administrativa individual ante las autoridades de supervisión y control (art. 6); y quien tenga conocimiento de que un producto que fabrica, importa o comercializa tiene un defecto que ha producido o puede producir un evento adverso contra la salud, la vida o la seguridad de las personas debe tomar las medidas correctivas frente a los productos no despachados y a los puestos en circulación e informar el hecho a la autoridad dentro de los tres (3) días calendario siguientes (art. 19). LA FACULTAD Y SU PRESUPUESTO — Ley 1480 de 2011, art. 59 num. 8: la Superintendencia de Industria y Comercio puede emitir las órdenes necesarias para que se suspenda EN FORMA INMEDIATA Y DE MANERA PREVENTIVA la producción o la comercialización de productos HASTA POR UN TÉRMINO DE SESENTA (60) DÍAS, PRORROGABLES HASTA POR UN TÉRMINO IGUAL, mientras se surte la investigación correspondiente, y lo puede hacer CUANDO SE TENGAN INDICIOS GRAVES de que el producto atenta contra la vida o la seguridad de los consumidores, o de que no cumple el reglamento técnico: ese estándar de indicios graves, y no el daño consumado, es lo que hay que acreditar en la solicitud, y de las dos hipótesis la segunda —incumplimiento del reglamento técnico— no exige demostrar riesgo, basta el incumplimiento. ESTE ARTÍCULO SE CITA CON LA CONDICIÓN QUE LE PUSO LA CORTE, porque su texto publicado no es el que rige: el num. 4, que faculta a la Superintendencia para practicar visitas de inspección así como cualquier otra prueba consagrada en la ley, es exequible únicamente en el entendido de que esas competencias deben ejercerse a la luz del Código de Procedimiento Administrativo y de lo Contencioso Administrativo y del Código General del Proceso, y de que NO comprenden interceptaciones o registros ni otras actividades probatorias sometidas por la Constitución a reserva judicial (Sentencia C-165 de 2019). Es el límite que enmarca lo que puede pedirse como prueba en la solicitud y lo que la entidad no puede practicar por sí sola.',
  ...
  },
  {
    ...
    branch: 'SUPERINTENDENCIAS',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1328 de 2009, arts. 13 y 14; Decreto 2555 de 2010, Parte 2, Libro 34, Título 2, art. 2.34.2.1.5 (procedimiento y términos). Debe dejar de citarse el art. 5 del Decreto 2281 de 2010, que está DEROGADO por el art. 12.2.1.1.4 del Decreto 2555 de 2010. Adviértase además que el artículo del procedimiento es el 2.34.2.1.5 y no el 2.34.2.1.1, que es el de «Ámbito de Aplicación» (modificado por el art. 5 del Decreto 2076 de 2017).',
    competentAuthority: 'Defensor del Consumidor Financiero de la entidad vigilada',
    term: { status: 'VERIFICADO', description: 'La Ley 1328 de 2009 no fija términos: su art. 13 lit. b) manda al Defensor «conocer y resolver en forma objetiva y gratuita para los consumidores, las quejas que estos le presenten, dentro de los términos y el procedimiento que se establezca para tal fin». Los términos vigentes están en el art. 2.34.2.1.5 del Decreto 2555 de 2010 (antes art. 5 del Decreto 2281 de 2010, derogado): si la queja se presenta en las oficinas del Defensor o en agencias o sucursales de la entidad, esta debe trasladarla al Defensor dentro de los tres (3) días hábiles siguientes a su recepción (num. 1); el Defensor comunica al consumidor y a la entidad si el asunto es de su competencia dentro de los tres (3) días hábiles contados desde el día siguiente al recibo de la solicitud (num. 3); si pide información adicional, la entidad o el consumidor responden en el término que fije el Defensor «sin que se excedan los ocho (8) días hábiles, contados desde el día siguiente al que se solicite la información», y recibida la información el Defensor decide sobre la admisión «dentro del término máximo de tres (3) días hábiles» (num. 4), entendiéndose DESISTIDA la queja si el consumidor no responde dentro de ese término máximo (num. 5); admitida la queja, la entidad responde el traslado «dentro de un término de ocho (8) días hábiles, contados desde el día siguiente al que se haga el traslado, término que se ampliará a petición de la entidad y a juicio del Defensor del Consumidor Financiero» (num. 6); el Defensor resuelve «en un término que en ningún caso podrá ser superior a ocho (8) días hábiles, contados desde el día siguiente al vencimiento del término estipulado en el numeral 6» (num. 8) y comunica la decisión «el día hábil siguiente después de proferida» (num. 9); si la entidad rectifica su posición, el Defensor consulta al consumidor «dentro de los tres (3) días hábiles siguientes a la comunicación de la entidad» y este responde «en un término máximo de ocho (8) días hábiles», entendiéndose satisfecho y terminado el trámite si guarda silencio (num. 10); el consumidor puede desistir en cualquier momento y el Defensor comunica la terminación «dentro de los tres (3) días hábiles siguientes a la recepción del desistimiento» (num. 12). RELOJ DEL CONSUMIDOR, el que extingue su derecho a este trámite: el Defensor no conoce «los que se refieran a hechos sucedidos con tres (3) años o más de anterioridad a la fecha de presentación de la solicitud ante el Defensor» ni aquellos «cuya cuantía, sumados todos los conceptos, supere los cien (100) salarios mínimos legales mensuales vigentes al momento de su presentación» (Ley 1328 de 2009, art. 14 lits. g e i); tampoco los asuntos «que se encuentren en trámite judicial o arbitral o hayan sido resueltas en estas vías» (lit. e). El trámite «no constituye requisito de procedibilidad para acudir a la Superintendencia Financiera de Colombia o ejercer en cualquier momento las acciones jurisdiccionales que los consumidores financieros estimen pertinentes» (parágrafo del art. 2.34.2.1.5).' },
    requiredSections: [
    ...
    sourceUrl: 'https://www.funcionpublica.gov.co/eva/gestornormativo/norma.php?i=40032'
  },
  {
    ...
    term: { status: 'VERIFICADO', description: 'EL ART. 24 NO FIJA TÉRMINOS PROPIOS: «Las autoridades administrativas tramitarán los procesos A TRAVÉS DE LAS MISMAS VÍAS PROCESALES PREVISTAS EN LA LEY PARA LOS JUECES» (art. 24 par. 3). Según la cuantía y la naturaleza del asunto, el trámite será VERBAL —traslado de VEINTE (20) DÍAS para contestar (art. 369)— o VERBAL SUMARIO de única instancia —DIEZ (10) DÍAS para contestar (arts. 390 y 391)—. Ambos son relojes del demandado. LA ELECCIÓN DEL FORO ES DEL DEMANDANTE: la competencia es A PREVENCIÓN con los jueces (art. 24 par. 1). Y estas dos reglas de impugnación son las que deben decidir esa elección, antes de radicar: PRIMERA — las providencias que la Superintendencia dicta en ejercicio de funciones jurisdiccionales NO SON IMPUGNABLES ANTE LA JURISDICCIÓN CONTENCIOSO ADMINISTRATIVA. SEGUNDA — las apelaciones de las dictadas en primera instancia las resuelve el SUPERIOR FUNCIONAL DEL JUEZ QUE HABRÍA SIDO COMPETENTE, y si ese juez habría conocido EN ÚNICA INSTANCIA, el asunto ante la Superintendencia TAMBIÉN SERÁ DE ÚNICA INSTANCIA, es decir, SIN APELACIÓN (art. 24 par. 3). Escoger la Superintendencia en un asunto de única instancia es renunciar a la segunda. RELOJ DE LA AUTORIDAD QUE JUEGA A FAVOR DEL DEMANDANTE: el plazo máximo de duración del proceso del art. 121 se aplica a las autoridades administrativas cuando ejercen funciones jurisdiccionales, y al perder competencia deben REMITIR EL EXPEDIENTE INMEDIATAMENTE a la autoridad judicial desplazada (art. 121 par.). POSTULACIÓN: ante la Superintendencia las partes pueden concurrir SIN ABOGADO solo en los casos en que tampoco habría sido necesario ante el juez (art. 24 par. 4).' },
    requiredSections: [
  ...
  },
  {
    ...
    branch: 'SUPERINTENDENCIAS',
    role: 'DESPACHO',
    legalBasis: 'Ley 1480 de 2011, art. 58 — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1480 de 2011, arts. 6 y 19: la medida se motiva en el incumplimiento del deber de todo productor de asegurar la idoneidad y seguridad de los bienes y servicios que ofrezca o ponga en el mercado, que en ningún caso pueden ser inferiores ni contravenir los reglamentos técnicos y las medidas sanitarias o fitosanitarias, incumplimiento que genera responsabilidad administrativa individual ante las autoridades de supervisión y control (art. 6); y en el deber de quien conoce que un producto suyo tiene un defecto que ha producido o puede producir un evento adverso contra la salud, la vida o la seguridad de las personas de tomar las medidas correctivas frente a los productos no despachados y a los puestos en circulación e informarlo a la autoridad dentro de los tres (3) días calendario siguientes (art. 19). LA COMPETENCIA QUE EL ACTO DEBE INVOCAR, Y LO QUE DEBE MOTIVAR — Ley 1480 de 2011, art. 59 num. 8: la Superintendencia de Industria y Comercio puede emitir las órdenes necesarias para que se suspenda EN FORMA INMEDIATA Y DE MANERA PREVENTIVA la producción o la comercialización de productos HASTA POR UN TÉRMINO DE SESENTA (60) DÍAS, PRORROGABLES HASTA POR UN TÉRMINO IGUAL, mientras se surte la investigación correspondiente, y solo CUANDO SE TENGAN INDICIOS GRAVES de que el producto atenta contra la vida o la seguridad de los consumidores, o de que no cumple el reglamento técnico. El acto debe dejar constancia de cuál de las dos hipótesis se configura y de cuáles son los indicios graves que la sostienen, porque un acto preventivo sin ese soporte queda sin el presupuesto que la ley exige; y el encabezado del artículo advierte que estas facultades se ejercen SIEMPRE Y CUANDO NO HAYAN SIDO ASIGNADAS DE MANERA EXPRESA A OTRA AUTORIDAD, de modo que la competencia también hay que motivarla. ESTE ARTÍCULO SE CITA CON LA CONDICIÓN QUE LE PUSO LA CORTE, porque su texto publicado no es el que rige: el num. 4, que faculta a la Superintendencia para practicar visitas de inspección así como cualquier otra prueba consagrada en la ley, es exequible únicamente en el entendido de que esas competencias deben ejercerse a la luz del Código de Procedimiento Administrativo y de lo Contencioso Administrativo y del Código General del Proceso, y de que NO comprenden interceptaciones o registros ni otras actividades probatorias sometidas por la Constitución a reserva judicial (Sentencia C-165 de 2019).',
    competentAuthority: 'Superintendencia de Industria y Comercio',
