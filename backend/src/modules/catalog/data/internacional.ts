...
export const INTERNACIONAL_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    term: { status: 'VERIFICADO', description: 'CINCO (5) DÍAS DE TRASLADO; vencidos se decretan y practican las pruebas, se convoca a audiencia y se dicta sentencia (art. 607). EL PASO SIN EL CUAL LA SENTENCIA DE EXEQUÁTUR NO PRODUCE EL RESULTADO BUSCADO: concedido el exequátur, si la sentencia extranjera REQUIERE EJECUCIÓN, el interesado debe promoverla ANTE EL JUEZ COMPETENTE conforme a las reglas generales (art. 607 num. 5), NO ante la Corte. El exequátur reconoce; no ejecuta. Terminar ahí es entregarle al cliente una sentencia que no cobra nada. QUÉ EFECTO SE RECONOCE, que define para qué sirve el trámite: el que le concedan los tratados existentes con el país de origen y, en su defecto, «el que allí se reconozca a las sentencias proferidas en Colombia» (art. 605) — reciprocidad diplomática primero, legislativa después.' },
    requiredSections: [
