...
export const TRANSITO_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    branch: 'TRANSITO',
    role: 'LITIGANTE',
    legalBasis: 'Ley 1843 de 2017, art. 8; Ley 769 de 2002, arts. 129 (pars. 1 y 2) y 136 (par. 2, adicionado por el art. 7 de la Ley 1843 de 2017) — FUNDAMENTO SUSTANCIAL (la causal, no el trámite): Ley 1843 de 2017, arts. 2, 13 y 14: todo sistema automático, semiautomático u otro medio tecnológico para la detección de presuntas infracciones al tránsito debe cumplir los criterios técnicos de seguridad vial que fije el Ministerio de Transporte junto con la Agencia Nacional de Seguridad Vial y debe contar con autorización de esa Agencia, autorización que dura cinco (5) años contados desde su otorgamiento (art. 2); su instalación exige además que haga parte del Plan Nacional y Territorial de Seguridad Vial, que esté soportada en estudios y análisis de entidad idónea sobre accidentalidad y flujo vehicular y peatonal, geometría, ubicación, calibración y tipo de equipos, que exista un cuerpo de agentes de tránsito capacitado y que haya señalización adecuada que informe de su existencia (art. 13); y los laboratorios acreditados deben demostrar la trazabilidad de los equipos medidores de velocidad conforme a los patrones de referencia nacional definidos por el Instituto Nacional de Metrología, a cuyo cargo está la calibración mientras no existan laboratorios acreditados en el territorio nacional (art. 14). LA TIPICIDAD, QUE ES CONTRA LO QUE SE CONTRASTA EL COMPARENDO — Ley 769 de 2002, art. 131 (modificado por el art. 21 de la Ley 1383 de 2010): las infracciones de tránsito están tipificadas y tarifadas por literales, y la multa solo procede si la conducta imputada corresponde EXACTAMENTE a uno de ellos: cuatro (4) SMLDV para las del literal A, propias del conductor de vehículo no automotor o de tracción animal; ocho (8) SMLDV para las del literal B; quince (15) SMLDV para las del literal C, entre ellas conducir a velocidad superior a la máxima permitida (C.29) y no acatar las señales o requerimientos de los agentes (C.31); treinta (30) SMLDV para las del literal D, entre ellas no detenerse ante una luz roja o amarilla de semáforo, una señal de PARE o un semáforo intermitente en rojo (D.4, modificado por el art. 2 de la Ley 2435 de 2024) y transitar en sentido contrario al estipulado para la vía, calzada o carril (D.3, del mismo origen); cuarenta y cinco (45) SMLDV para las del literal E; seis (6) SMLDV para las del literal G, adicionado por el art. 4 de la Ley 2486 de 2025 para vehículos eléctricos livianos de movilidad personal urbana; y para conducir bajo el influjo del alcohol o de sustancias psicoactivas, las multas del art. 152, duplicadas si el conductor es de servicio público, escolar o instructor de conducción (literal F, adicionado por el art. 4 de la Ley 1696 de 2013). ESTE ARTÍCULO NO SE PUEDE CITAR COMO SE LEE, PORQUE LA CORTE LO TOCÓ EN DOS PUNTOS: el numeral A.12 —prestar servicio público con vehículo no automotor— es exequible solo bajo el entendido de que la sanción SÓLO SERÁ APLICABLE PREVIA REGLAMENTACIÓN de las autoridades territoriales competentes que señale las condiciones de tiempo, modo y lugar de la restricción, de manera que sin esa reglamentación la multa no procede (Sentencia C-981 de 2010); y el literal D.7 —conducir realizando maniobras altamente peligrosas e irresponsables que pongan en peligro a las personas o las cosas— es exequible solo en el entendido de que debe tratarse de maniobras QUE VIOLEN LAS NORMAS DE TRÁNSITO, que pongan en peligro a las personas o a las cosas, Y QUE CONSTITUYAN CONDUCTAS DOLOSAS O ALTAMENTE IMPRUDENTES, de modo que la simple maniobra riesgosa no basta (Sentencia C-530 de 2003, que en el texto original numeraba este literal como D.8). A QUIÉN SE LE PUEDE IMPUTAR, que es el punto donde más se cae un fotocomparendo: aunque los literales B, C, D y E digan el conductor y o propietario, la misma Sentencia C-530 de 2003 declaró INEXEQUIBLE el aparte del inciso 1 del art. 129 que ordenaba imponer la sanción al propietario registrado en caso de no concurrir, y condicionó el resto de ese inciso a que EL PROPIETARIO SÓLO SEA LLAMADO A DESCARGOS CUANDO EXISTAN ELEMENTOS PROBATORIOS QUE PERMITAN INFERIR QUE PROBABLEMENTE ES EL RESPONSABLE DE LA INFRACCIÓN, y el inciso tercero del art. 137 a que la actuación solo pueda culminarse cuando la administración haya agotado todos los medios para hacer comparecer al citado y a que LA SANCIÓN SÓLO PUEDA IMPONERSE CUANDO APAREZCA PLENAMENTE COMPROBADO QUE EL CITADO ES EL INFRACTOR, precisando además que cuando el propietario no coincide con el conductor la citación no implica vinculación alguna.',
    competentAuthority: 'Organismo de tránsito competente',
