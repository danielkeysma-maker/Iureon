...
export const AGRARIO_CATALOG: BranchCatalog = {
  ...
  },
  {
    ...
    competentAuthority: 'Juez competente según la materia mientras la jurisdicción agraria y rural no asuma competencias: la jurisdicción de lo contencioso administrativo para el control de los actos administrativos del Procedimiento Único, y «los demás procesos deberán adelantarse ante el juez que corresponda según su materia» (Sentencia C-073 de 2018, que declaró INEXEQUIBLE el art. 78 del Decreto Ley 902 de 2017). La Sentencia C-099 de 2026 (22 de abril de 2026, M.P. Vladimir Fernández Andrade) precisa que esa competencia «continuará siendo ejercida por las autoridades judiciales establecidas en la Sentencia C-073 de 2018 hasta que la justicia agraria y rural asuma las competencias que le corresponden conforme al Acto Legislativo 03 de 2023». En la jurisdicción ordinaria, los asuntos «originados en relaciones de naturaleza agraria» son de los jueces civiles municipales (mínima cuantía, CGP art. 17 num. 1; menor cuantía, art. 18 num. 1) y de los jueces civiles del circuito (mayor cuantía, art. 20 num. 1), con competencia territorial privativa del juez del lugar de ubicación del inmueble (CGP art. 28 num. 7)',
    term: { status: 'NO_VERIFICADO', description: 'SIN PLAZO EN LA NORMA, Y SE COMPROBÓ LEYENDO EL ARTÍCULO ENTERO: el art. 38 del Decreto Ley 902 de 2017 describe quién puede pedirla, qué determina el juez y qué puede ordenar, pero NO fija término de caducidad ni de prescripción. «Para aquellos casos en los que se cuestione la validez y eficacia de los actos o instrumentos con los que se hayan efectuado programas de titulación o adjudicación de tierras, el juez competente, POR SOLICITUD DE LA AGENCIA NACIONAL DE TIERRAS, O DE LOS PARTICULARES AFECTADOS, conocerá de la acción de resolución de controversias sobre la adjudicación.» LO QUE SÍ HAY QUE VIGILAR NO ES UN CALENDARIO SINO UNA COMPETENCIA EN TRANSICIÓN, y equivocarla cuesta el proceso entero: la Sentencia C-073 de 2018 declaró INEXEQUIBLE el art. 78 del mismo decreto, de modo que no existe el juez agrario que la norma suponía, y la C-099 de 2026 precisó que la competencia «continuará siendo ejercida por las autoridades judiciales establecidas en la Sentencia C-073 de 2018 HASTA QUE LA JUSTICIA AGRARIA Y RURAL ASUMA LAS COMPETENCIAS que le corresponden conforme al Acto Legislativo 03 de 2023». Antes de radicar hay que verificar si esa jurisdicción ya entró en funcionamiento. RIESGO PARA EL ADJUDICATARIO DE BUENA FE que conviene advertirle: si se declara la ineficacia de su título, el juez «podrá ordenar el reconocimiento del Subsidio Integral de Reforma Agraria a título de indemnización», y resueltas las controversias «ordenará la RECUPERACIÓN MATERIAL INMEDIATA del bien inmueble». LÍMITE DE APLICACIÓN: el parágrafo excluye los territorios del art. 22 del decreto.' },
    requiredSections: [
  ...
  },
  {
    ...
    term: { status: 'NO_VERIFICADO', description: 'SIN PLAZO PARA PEDIRLA, Y EL ÚNICO TÉRMINO DEL ARTÍCULO NO ES DEL CLIENTE SINO QUE LO FIJA LA PROPIA AGENCIA: en los procedimientos administrativos, los funcionarios «desde el momento en que sean informados por la Agencia Nacional de Tierras en cualquiera de las etapas del Procedimiento Único, PERDERÁN COMPETENCIA sobre los trámites respectivos y procederán a remitírselos a dicha entidad EN EL TÉRMINO QUE ESTA SEÑALE» (art. 56 inc. 2). Es decir, la pérdida de competencia opera con la sola información, no con el vencimiento de un plazo. QUÉ SE ACUMULA, y es más amplio de lo que suele creerse: los procesos administrativos o judiciales en curso «cuyo objeto sea resolver el derecho real de propiedad, la posesión, uso y/o goce sobre los predios rurales, INCLUIDOS LOS PROCESOS EJECUTIVOS CON GARANTÍA HIPOTECARIA o sobre los cuales recaigan medidas cautelares sobre el inmueble», con las reglas del art. 165 de la Ley 1437 de 2011. QUIÉN LA PIDE ANTE EL JUEZ: la solicitud judicial la formula la ANT, no el particular — «la Agencia Nacional de Tierras identificará los procesos […] y solicitará al juez competente […] la respectiva acumulación». El particular lo que hace es informar a la ANT. EFECTO VECINO QUE HAY QUE MIRAR JUNTO CON ESTE: el art. 57 suspende los procesos judiciales que vinculen esos predios aunque sus pretensiones sean otras. Artículo declarado CONDICIONALMENTE EXEQUIBLE.' },
    requiredSections: [
  ...
  },
  {
    ...
    term: { status: 'NO_VERIFICADO', description: 'SIN PLAZO: SE PUEDE PEDIR EN CUALQUIER MOMENTO, Y ESO ES PRECISAMENTE LO VALIOSO. «DURANTE TODO EL DESARROLLO del Procedimiento Único de que trata el presente decreto ley se fomentarán e implementarán los Mecanismos Alternativos de Solución de Conflictos, preferiblemente la conciliación sobre asuntos entre particulares relacionados con predios rurales» (art. 55). NO ES UN TRÁMITE MENOR: EVITA LA ETAPA JUDICIAL. Los asuntos de los numerales 4, 5, 6, 7 y 10 del art. 58 «SIEMPRE PASARÁN A ETAPA JUDICIAL para su decisión de fondo, con independencia de que se hubieren presentado o no oposiciones en el trámite administrativo, SALVO QUE durante el desarrollo del proceso administrativo EXISTA UN ACUERDO O CONCILIACIÓN entre las partes procesales» (art. 61). Conciliar a tiempo es la diferencia entre cerrar en sede administrativa y entrar a un proceso judicial cuya competencia, además, sigue en transición. ANTE QUIÉN, y la lista es amplia y gratuita en buena parte: la ANT, los delegados regionales y seccionales de la Defensoría del Pueblo, los personeros municipales y distritales, los procuradores y defensores agrarios, los centros de conciliación autorizados por el Ministerio de Justicia y los conciliadores en equidad. VENTAJA REGISTRAL QUE AHORRA DINERO: «Las actas de conciliación que requieran registro serán registradas SIN QUE PARA ESTO SEA NECESARIO ELEVARLAS A ESCRITURA PÚBLICA y ESTÁN EXENTAS DE LA TARIFA por el ejercicio registral.»' },
    requiredSections: [
