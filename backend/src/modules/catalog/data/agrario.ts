...
export const AGRARIO_CATALOG: BranchCatalog = {
  meta: {
    branch: 'AGRARIO',
    verifiedAt: '',
    sourceOfTruth: 'PASO 0 — LA JURISDICCIÓN AGRARIA Y RURAL EXISTE, PERO HOY NO TIENE NI JUECES INSTALADOS NI PROCEDIMIENTO PROPIO. Verificado el 2026-08-26 contra texto oficial. 1) CREACIÓN CONSTITUCIONAL. El Acto Legislativo 03 de 2023 creó la Jurisdicción Agraria y Rural: su art. 1 la incluyó en el art. 116 de la Constitución y su art. 2 agregó el art. 238A. Su art. 4 ordenó al Congreso expedir en la siguiente legislatura la ley de estructura, funcionamiento, competencias y procedimiento especial agrario y rural. Fuente: https://www.funcionpublica.gov.co/eva/gestornormativo/norma.php?i=214630 2) LEY ESTATUTARIA VIGENTE, PERO SOLO DE ESTRUCTURA. La Ley Estatutaria 2570 de 2026 (27 de marzo de 2026, Diario Oficial No. 53.444 de 30 de marzo de 2026) modificó la Ley 270 de 1996 y determinó «la integración y estructura de la jurisdicción agraria y rural»; fue revisada por la Corte Constitucional en la Sentencia C-340 de 2025 (14 de agosto de 2025, M.P. Jorge Enrique Ibáñez Najar), que la declaró constitucional con condicionamientos. Su art. 10 dispone que «rige a partir de su promulgación». Pero NO fija competencias ni procedimiento: solo crea órganos —Sala de Casación Civil, Agraria y Rural de la Corte Suprema, Tribunales Agrarios y Rurales y Juzgados Agrarios y Rurales— y remite a «las funciones que determine la ley procesal» (arts. 51A y 56A), y a un concurso de méritos que el Consejo Superior de la Judicatura debe convocar dentro de los seis (6) meses siguientes a la expedición de la ley y culminar en un plazo no mayor a dieciocho (18) meses (art. 6 parágrafo 1). Fuente: http://www.secretariasenado.gov.co/senado/basedoc/ley_2570_2026.html 3) NO HAY LEY DE COMPETENCIAS NI PROCEDIMIENTO AGRARIO. El proyecto de ley ordinaria 183 de 2024 Senado — 398 de 2024 Cámara, «por medio de la cual se determinan las competencias de la jurisdicción agraria y rural, se establece el procedimiento especial agrario y rural», no fue aprobado y se archivó al terminar la legislatura en junio de 2026. El Gobierno lo radicó de nuevo el 21 de julio de 2026: es un PROYECTO, no derecho vigente (regla 5 de la doctrina). Fuente oficial: https://www.minjusticia.gov.co/Sala-de-prensa/Paginas/Jurisdiccion-Agraria-da-paso-decisivo-hacia-su-puesta-en-marcha_-el-Minjusticia-acompa%C3%B1o-la-radicacion-de-proyecto-de-ley.aspx El Consejo Superior de la Judicatura mantiene el llamado de urgencia a su aprobación: https://www.ramajudicial.gov.co/web/consejo-superior-de-la-judicatura/-/consejo-superior-de-la-judicatura-reitera-la-urgencia-de-aprobaci%C3%B3n-de-la-ley-ordinaria-de-la-jurisdicci%C3%B3n-agraria-y-rural 4) EL PROCEDIMIENTO AGRARIO DE 1989 ESTÁ DEROGADO ENTERO, no en parte. El art. 626 lit. c) del Código General del Proceso (Ley 1564 de 2012) lo dice con nombre propio, en la misma lista en que derogó el CPC: «el Decreto número 2272 de 1989; el Decreto número 2273 de 1989; el Decreto número 2303 de 1989». Fuente: http://www.secretariasenado.gov.co/senado/basedoc/ley_1564_2012_pr021.html 5) QUIÉN CONOCE HOY LOS ASUNTOS AGRARIOS: la jurisdicción ordinaria civil, por cuantía, con el procedimiento del CGP. Los tres artículos de competencia usan la misma fórmula literal — jueces civiles municipales en única instancia, «De los procesos contenciosos de mínima cuantía, incluso los originados en relaciones de naturaleza agraria, salvo los que correspondan a la jurisdicción contencioso administrativa» (CGP art. 17 num. 1); en primera instancia, los de menor cuantía con idéntica fórmula (art. 18 num. 1); y jueces civiles del circuito, «De los contenciosos de mayor cuantía, incluso los originados en relaciones de naturaleza agraria salvo los que le correspondan a la jurisdicción contencioso administrativa» (art. 20 num. 1). El foro es privativo del lugar del inmueble en los procesos sobre derechos reales, deslinde y amojonamiento, servidumbres, posesorios y pertenencia (art. 28 num. 7). Fuente: http://www.secretariasenado.gov.co/senado/basedoc/ley_1564_2012.html 6) LA FASE JUDICIAL DEL PROCEDIMIENTO ÚNICO NO TIENE JUEZ PROPIO NI PROCEDIMIENTO PROPIO. El art. 78 del Decreto Ley 902 de 2017, que atribuía la etapa judicial a «las autoridades judiciales que se determinen o creen», fue declarado INEXEQUIBLE por la Sentencia C-073 de 2018 (12 de julio de 2018, M.P. Cristina Pardo Schlesinger), porque «la ley no podía establecer una competencia judicial indeterminada para el trámite del Procedimiento Único, por vulnerar las garantías de juez natural y de acceso a la administración de justicia»; esa misma sentencia fijó la regla de reemplazo: «el juez natural para el control de los actos administrativos que se produzcan en aplicación del Procedimiento único en fase administrativa es, necesariamente, la jurisdicción contencioso administrativa. Los demás procesos deberán adelantarse ante el juez que corresponda según su materia.» La Sentencia C-099 de 2026 (22 de abril de 2026, M.P. Vladimir Fernández Andrade) declaró condicionalmente exequibles los arts. 36, 38, 39, 47, 53, 56 y 57 del mismo decreto «bajo el entendido de que la competencia jurisdiccional a la que allí se hace referencia continuará siendo ejercida por las autoridades judiciales establecidas en la Sentencia C-073 de 2018 hasta que la justicia agraria y rural asuma las competencias que le corresponden conforme al Acto Legislativo 03 de 2023», y declaró INEXEQUIBLE en esos artículos la expresión «en los términos del presente decreto ley». El art. 79 mantiene la regla supletoria: «Mientras se expide un procedimiento judicial especial […] se aplicarán las normas de la Ley 1564 de 2012 relativas al proceso verbal sumario». Notas de vigencia oficiales: http://www.secretariasenado.gov.co/senado/basedoc/js/decreto_0902_2017_pr001.js y http://www.secretariasenado.gov.co/senado/basedoc/js/decreto_0902_2017.js RESPUESTA AL PASO 0. (i) ¿Existe hoy la jurisdicción o el procedimiento? La jurisdicción existe en la Constitución y en la Ley 2570 de 2026; los jueces agrarios NO están instalados y NO hay procedimiento agrario vigente: se aplica el CGP. Por eso esta rama no contiene ni una sola ficha de «proceso agrario». (ii) ¿Se solapa? No se catalogó el proceso verbal ni el verbal sumario del CGP, ni el deslinde y amojonamiento ni la declaración de pertenencia (ya están en CIVIL), ni el control judicial de los actos de adjudicación de baldíos, clarificación, deslinde, recuperación de baldíos, extinción del dominio agrario y expropiación de inmueble agrario (ya están en ADMINISTRATIVO como demandas del art. 164 de la Ley 1437 de 2011). (iii) ¿Tiene materia propia? Sí, una y solo una: el Procedimiento Único de ordenamiento social de la propiedad rural del Decreto Ley 902 de 2017 (Diario Oficial No. 50.248 de 29 de mayo de 2017), vigente, con su fase administrativa ante la Agencia Nacional de Tierras y sus dos acciones propias —nulidad agraria (art. 39) y resolución de controversias sobre la adjudicación (art. 38)—, que no está en ninguna otra rama. Eso es esta rama: 13 fichas, todas del Decreto Ley 902 de 2017, leídas artículo por artículo en el texto oficial. Cuando se expida la ley ordinaria de competencias y procedimiento agrario, esta rama debe reconstruirse: hoy no existe un solo término judicial agrario que citar.',
    gaps: [
