...
import { billingMovementsController, billingStatementController, billingSummaryController } from './billing.controller';
...
router.get('/billing/statement', billingStatementController as any);
